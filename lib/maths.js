...
function intersectRayArc(rayStart, rayDir, arcCenter, arcRadius, arcStartAngle, arcEndAngle)
{
	...
	var nearValid = (angleNear - startAngle + 360) % 360 >= 0 && (angleNear - startAngle + 360) % 360 <= (endAngle - startAngle + 360) % 360;
	var farValid = (angleFar - startAngle + 360) % 360 >= 0 && (angleFar - startAngle + 360) % 360 <= (endAngle - startAngle + 360) % 360;
