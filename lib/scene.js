function Scene()
{
	...
	this.hitTest = function(a, b)
	{
		...
		for (var i=0; i<this.objects.length; ++i)
		{
			...
			if (this.objects[i].hitTest !== undefined && this.objects[i].hitTest(a,b) == true && !this.objects[i].isFrozen()&& this.objects[i].isVisible())
			{
	...
	this.getDragPoint = function(mousePos, camera, localSpace, ignoreObjectList)
	{
		var bestPoint = null;
		var bestObject = null;
		var bestIndex = null;
