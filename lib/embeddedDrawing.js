function EmbeddedDrawing(docTag)
{
	...
	function setup(_this)
	{
		...
		// Context menu
		{
			...
			contextMenuDock.style.minWidth = 150;
			...
			//contextMenuBox.style.margin = "3 3";
			contextMenuBox.style.padding = 3;
	...
	function onContextMenu(evt)
	{
		...
		contextMenuDock.style.left = evt.x;
		contextMenuDock.style.top = evt.y;
	...
	function onMouseMove(evt)
	{
		...
		{
			this.onMouseMove(lastMousePos, lastMousePosPixels, evt.buttons, evt.ctrlKey);
		}
	}
