function EmbeddedDrawing(docTag)
{
	...
	function onTouchStart(evt)
	{
		...
		else if (touchPositions.length == 2)
		{
			...
			console.log("pinch start, length = " + pinchStartLength + ", scale = " + pinchStartUnitScale.toFixed(3));
		}
	...
	{
		//var newMousePosPixels = getTouchPositionsPixels(evt, canvas)[0];
		...
		else if (touchPositions.length == 2) // pan & zoom
		{
			...
			console.log("pinch move, length = " + pinchLength + ", zoomFactor = " + zoomFactor.toFixed(3));
