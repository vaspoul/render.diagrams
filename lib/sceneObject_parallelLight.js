...
function ParallelLight(O, dir)
{
	...
	this.draw = function(camera)
	{
		...
		if (this.collisionOutline)
		{
			...
			camera.drawLineStrip(points, false, this.appearance.GetLineColor(), this.appearance.GetLineWidth(this.selected), undefined, undefined, this);
		}
	...
	this.getSnapPoints = function()
	{
		...
		{
			points.push({ type: "node", p: this.collisionPoints[i]});
		}
