function GeneralDrawing(docTag)
{
	...
	function setTool(newTool)
	{
		...
		else if (newTool == "addPointLight"  || newTool == "addRect" || newTool == "addHemisphere" || newTool == "addNGon" || newTool == "addCapsule" || newTool == "addDimension" || newTool == "takeScreenshot" || newTool == "addPageOutline" || newTool == "addFunctionGraph" || newTool == "addBouncingBall")
		{
			if (tool != newTool)
			{
				mode = null;
	...
	function onMouseUp(evt)
	{
		...
		if (evt.button == 0) // object move or marquee
		{
			...
			else if (tool == "addWall" || tool == "addArcWall" || tool == "addRay" || tool == "addPointLight" || tool == "addSpotLight" || tool == "addParallelLight" || tool == "addCamera" || tool == "addLine" || tool == "addRect" || tool == "addHemisphere" || tool == "addNGon" || tool == "addCapsule" || tool == "addDimension" || tool == "addBarChart" || tool == "addFunctionGraph" || tool == "takeScreenshot" || tool == "addText" || tool == "addAxis" || tool == "addPageOutline" || tool == "addBouncingBall" || tool == "addDiffractionGrating")
			{
				if (evt.altKey == 0)
				{
