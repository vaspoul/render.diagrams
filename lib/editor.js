function GeneralDrawing(docTag)
{
	...
	function setup()
	{
		...
		// Object list
		{
			...
			(new Button("images/group_selection.svg",	[18,18], undefined, "Group (Ctrl+G)", groupSelection )).addControls(buttonArea);
			(new Button("images/ungroup_selection.svg",	[18,18], undefined, "Ungroup (Ctrl+G)", ungroupSelection )).addControls(buttonArea);
			(new Button("images/move_up.svg",			[18,18], undefined, "Move Up", moveUpSelection )).addControls(buttonArea);
			(new Button("images/move_down.svg",			[18,18], undefined, "Move Down", moveDownSelection )).addControls(buttonArea);
		...
		// File controls
		{
			...
			popoutMenuButton.addControl(new Button("images/save_drawing_image.svg", [24,24], "Save as Image", "Hint text",			function () { setTool("takeScreenshot");	}));
			...
			popoutMenuButton.addControl(new Button("images/preferences.svg",	[18,18],	"Reset Preferences", undefined,	function () { clearPreferences(); })); 
			popoutMenuButton.addControl(new Divider());
		...
		// Canvas controls
		{
			...
			var popout = new MultiToolButton([18,18]);
			popout.addButton("images/hide_selected.svg",			undefined, "Hide Selected",		function() { alert("missing functionality"); }	 );
			popout.addButton("images/hide_unselected.svg",		undefined, "Hide Unselected",	function() { alert("missing functionality"); }	 );
			popout.addControls(canvasControls);
				
			var popout = new MultiToolButton([18,18]);
			popout.addButton("images/hide_selected.svg",			undefined, "Freeze Selected",	function() { alert("missing functionality"); }	 );
			popout.addButton("images/hide_unselected.svg",	undefined, "Freeze Unselected",	function() { alert("missing functionality"); }	 );
			popout.addControls(canvasControls);
