function GeneralDrawing(docTag)
{
	...
	function setTool(newTool)
	{
		...
		else if (newTool == "addPointLight"  || newTool == "addRect" || newTool == "addHemisphere" || newTool == "addNGon" || newTool == "addCapsule" || newTool == "addPoint" || newTool == "addLens" || newTool == "addDimension" || newTool == "takeScreenshot" || newTool == "addPageOutline" || newTool == "addFunctionGraph" || newTool == "addBouncingBall")
		{
			if (tool != newTool)
			{
				mode = null;
	...
	function onMouseMove(evt)
	{
		...
		if (evt.buttons == 0)
		{
			...
			else if (tool == "addWall" || tool == "addArcWall" || tool == "addRay" || tool == "addPointLight" || tool == "addSpotLight" || tool == "addParallelLight" || tool == "addCamera" || tool == "addLine" || tool == "addRect" || tool == "addHemisphere" || tool == "addNGon" || tool == "addCapsule" || tool == "addPoint" || tool == "addLens" || tool == "addDimension" || tool == "addBarChart" || tool == "addFunctionGraph" || tool == "takeScreenshot" || tool == "addText" || tool == "addAxis" || tool == "addPageOutline" || tool == "addBouncingBall" || tool == "addDiffractionGrating")
			{
				...
				else if (tool == "addArcWall" || tool == "addRay" || tool == "addSpotLight" || tool == "addParallelLight" || tool == "addCamera" || tool == "addBarChart" || tool == "addText" || tool == "addAxis" || tool == "addDiffractionGrating")
				{
					if (objectBeingMade !== undefined)
					{
