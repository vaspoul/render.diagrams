function GeneralDrawing(docTag)
{
	...
	function setup()
	{
		...
		// Object list
		{
			...
			(new Button("images/favourite-31.svg",		[18,18], undefined, "Group (Ctrl+G)", groupSelection )).addControls(buttonArea);
			(new Button("images/award-48.svg",			[18,18], undefined, "Ungroup (Ctrl+G)", ungroupSelection )).addControls(buttonArea);
			(new Button("images/square-upload.svg",		[18,18], undefined, "Move Up", moveUpSelection )).addControls(buttonArea);
			(new Button("images/square-download.svg",	[18,18], undefined, "Move Down", moveDownSelection )).addControls(buttonArea);
		...
		// Tool palette
		{
			...
			(new Button("images/cloud-computing-2.svg",	[18,18], "Select/Move (Q)", "Hint text",		function(){setTool("select");} )).addControls(toolPalette);
			(new Button("images/cloud-computing-3.svg",	[18,18], "Transform (T)", "Hint text",		function(){setTool("transform");} )).addControls(toolPalette);
			(new Button("images/cloud-computing-4.svg",	[18,18], "Modify (V)", "Hint text",			function(){setTool("modify");} )).addControls(toolPalette);

			(new Divider()).addControls(toolPalette);

			(new Button("images/barcode-qr.svg",	[18,18], "Wall (W)", "Hint text",			function () { setTool("addWall");} )).addControls(toolPalette);
			(new Button("images/award-48.svg",		[18,18], "Arc Wall", "Hint text",			function () { setTool("addArcWall");} )).addControls(toolPalette);
			(new Button("images/briefcase-24.svg",	[18,18], "BRDF Ray (B)", "Hint text",		function () { setTool("addRay"); } )).addControls(toolPalette);
			...
			(new Button("images/settings-gear-63.svg",	[18,18],	"Camera (C)", "Hint text",				function () { setTool("addCamera"); }		)).addControls(toolPalette);
			(new Button("images/single-01.svg",			[18,18],	"BRDF Hemisphere", "Hint text",			function () { setTool("addHemisphere"); }	)).addControls(toolPalette);
			(new Button("images/phone-2.svg",			[18,18],	"Line (L)", "Hint text",				function () { setTool("addLine"); }			)).addControls(toolPalette);
			(new Button("images/preferences.svg",		[18,18],	"Rectangle (R)", "Hint text",			function () { setTool("addRect"); }			)).addControls(toolPalette);
			(new Button("images/support-16.svg",		[18,18],	"Circle / NGon (N)", "Hint text",		function () { setTool("addNGon"); }			)).addControls(toolPalette);
			(new Button("images/switch.svg",			[18,18],	"Bar Chart", "Hint text",				function () { setTool("addBarChart"); }		)).addControls(toolPalette);
			(new Button("images/switch.svg",			[18,18],	"Function Graph", "Hint text",			function () { alert("missing functionality"); setTool("addFunctionGraph"); }		)).addControls(toolPalette);
			(new Button("images/flash-21.svg",			[18,18],	"Dimension (D)", "Hint text",			function () { setTool("addDimension"); }	)).addControls(toolPalette);
			(new Button("images/flag-points-32.svg",	[18,18],	"Text (X)", "Hint text",				function () { setTool("addText");}			)).addControls(toolPalette);
			(new Button("images/eye-19.svg",			[18,18],	"Axis", "Hint text",					function () { setTool("addAxis"); }			)).addControls(toolPalette);
			(new Button("images/flash-21.svg",			[18,18],	"Page Outline", "Hint text",			function () { alert("missing functionality"); setTool("addPageOutline"); }	)).addControls(toolPalette);
			...
			(new Button("images/logout-1.svg", [18,18], undefined, "Hide Labels", function () 
					{
		...
		// Canvas controls
		{
			...
			(new Button("images/logout-1.svg",			[18,18],	undefined, "Undo (Ctrl+Z)",			function () { undo(); }	)).addControls(canvasControls);
			(new Button("images/login-1.svg",			[18,18],	undefined, "Redo (Ctrl+Shit+Z)", 	function () { redo(); }	)).addControls(canvasControls);
	...
	function ShowGlobalHint(title, hintText)
	{
		...
		if (preferences.showHint && preferences.showHint == false)
		{
