function GeneralDrawing(docTag)
{
	...
	function setup()
	{
		...
		// Scene controls
		{
			...
			sceneControlDock.style.border = "1px solid #DDDDDD";
		...
		// Canvas controls
		{
			...
			canvasControl.style.width = 320;
			canvasControl.style.padding = "0 5px";
			canvasControl.style.background = "#EEEEEE";
			...
			var popout = new MultiToolButton([18,18]);
			popout.addButton("images/menu-5.svg",		"{hint}Grid: Cartesian",	function() { showGrid = true; grid.type = 0; layerDirty[0] = true; draw(); }	 );
			popout.addButton("images/vector.svg",		"{hint}Grid: Isometric",	function() { showGrid = true; grid.type = 1; layerDirty[0] = true; draw(); }	 );
			popout.addButton("images/lock-open.svg",	"{hint}Grid: Radial",		function() { showGrid = true; grid.type = 2; layerDirty[0] = true; draw(); }	 );
			popout.addButton("images/world.svg",		"{hint}Grid: None",			function() { showGrid = false; layerDirty[0] = true; draw(); }					 );
			popout.addControls(canvasControlDock);

				
			(new Button("images/settings-gear-63.svg", [18,18], "{hint}Zoom Extents", function () { zoomExtents(); } )).addControls(canvasControlDock);
			(new Button("images/world.svg", [18,18], "{hint}Test", function () {  } )).addControls(canvasControlDock);
			(new Button("images/vector.svg", [18,18], "{hint}Test", function () {  } )).addControls(canvasControlDock);
