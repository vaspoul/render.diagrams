function GeneralDrawing(docTag)
{
	...
	function setup()
	{
		...
		// File controls
		{
			...
			popoutMenuButton.addControl(new Button("images/export_drawing_js.svg", [24,24],			"Export as JavaScript",		undefined, function () { alert("COMING SOON!"); saveAsJavascript();			}));
			popoutMenuButton.addControl(new Button("images/import_drawing_js.svg", [24,24],			"Import from JavaScript",	undefined, function () { alert("COMING SOON!"); loadFromJavascript();		}));
			popoutMenuButton.addControl(new Button("images/open_example.svg", [24,24],				"Open Example",				undefined, function () { alert("COMING SOON!");	}));
	...
	function onKeyDown(evt)
	{
		...
		else if (evt.keyCode == 78 && evt.ctrlKey == 1) // Ctrl + N
		{
			newDrawing();
		}
