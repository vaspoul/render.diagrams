function GeneralDrawing(docTag)
{
	...
	function setup()
	{
		...
		// Menu bar
		{
			...
			{
				menuButton.addControl( new Button("images/new_drawing.svg", [18,18],				"New Diagram (Ctrl+Alt+N)",			undefined, function ()	{ newDrawing();						}));
				menuButton.addControl( new Button("images/save_drawing_localstorage.svg", [18,18],  "Save to LocalStorage (Ctrl+S)",	undefined, function ()	{ saveToLocalStorage();				}));
				menuButton.addControl( new Button("images/load_drawing_localstorage.svg", [18,18],  "Load from LocalStorage (Ctrl+O)",	undefined, function ()	{ openLocalStorage();				}));
			...
			{
				menuButton.addControl(new Button("images/help_about.svg", [18,18],				"Undo (Ctrl + X)",				undefined, function () { alert("COMING SOON!"); }));
				menuButton.addControl(new Button("images/help_about.svg", [18,18],				"Redo (Ctrl + X)",				undefined, function () { alert("COMING SOON!"); }));

				menuButton.addControl(new Divider());
	
				menuButton.addControl(new Button("images/help_about.svg", [18,18],				"Cut (Ctrl + X)",				undefined, function () { alert("COMING SOON!"); }));
				menuButton.addControl(new Button("images/help_about.svg", [18,18],				"Copy (Ctrl + X)",				undefined, function () { alert("COMING SOON!"); }));
				menuButton.addControl(new Button("images/help_about.svg", [18,18],				"Paste (Ctrl + X)",				undefined, function () { alert("COMING SOON!"); }));

				menuButton.addControl(new Divider());

				menuButton.addControl(new Button("images/help_about.svg", [18,18],				"Freeze Selected (Ctrl + X)",				undefined, function () { alert("COMING SOON!"); }));
				menuButton.addControl(new Button("images/help_about.svg", [18,18],				"Freeze Unselected (Ctrl + X)",				undefined, function () { alert("COMING SOON!"); }));
				menuButton.addControl(new Button("images/help_about.svg", [18,18],				"Unfreeze Selected (Ctrl + X)",				undefined, function () { alert("COMING SOON!"); }));
				menuButton.addControl(new Button("images/help_about.svg", [18,18],				"Unfreeze Unselected (Ctrl + X)",			undefined, function () { alert("COMING SOON!"); }));
				menuButton.addControl(new Button("images/help_about.svg", [18,18],				"Unfreeze All (Ctrl + X)",					undefined, function () { alert("COMING SOON!"); }));

				menuButton.addControl(new Divider());

				menuButton.addControl(new Button("images/help_about.svg", [18,18],				"Hide Selected (Ctrl + X)",					undefined, function () { alert("COMING SOON!"); }));
				menuButton.addControl(new Button("images/help_about.svg", [18,18],				"Hide Unselected (Ctrl + X)",				undefined, function () { alert("COMING SOON!"); }));
				menuButton.addControl(new Button("images/help_about.svg", [18,18],				"Unhide Selected (Ctrl + X)",				undefined, function () { alert("COMING SOON!"); }));
				menuButton.addControl(new Button("images/help_about.svg", [18,18],				"Unhide Unselected (Ctrl + X)",				undefined, function () { alert("COMING SOON!"); }));
				menuButton.addControl(new Button("images/help_about.svg", [18,18],				"Unhide All (Ctrl + X)",					undefined, function () { alert("COMING SOON!"); }));

				menuButton.addControl(new Divider());

				menuButton.addControl(new Button("images/help_about.svg", [18,18],				"Group (Ctrl + X)",						undefined, function () { alert("COMING SOON!"); }));
				menuButton.addControl(new Button("images/help_about.svg", [18,18],				"Ungroup (Ctrl + X)",					undefined, function () { alert("COMING SOON!"); }));
			}
			menuButton.addControls(menuBar);

			var menuButton = new MenuPopoutButton(undefined, undefined, "View", "bottom");
			{
				menuButton.addControl(new Button("images/help_about.svg", [18,18],				"Zoom Selected (Ctrl + X)",						undefined, function () { alert("COMING SOON!"); }));
				menuButton.addControl(new Button("images/help_about.svg", [18,18],				"Zoom Extents (Ctrl + X)",						undefined, function () { alert("COMING SOON!"); }));

				menuButton.addControl(new Divider());

				menuButton.addControl(new Button("images/help_about.svg", [18,18],				"Cartesian Grid (Ctrl + X)",					undefined, function () { alert("COMING SOON!"); }));
				menuButton.addControl(new Button("images/help_about.svg", [18,18],				"Radial Grid (Ctrl + X)",						undefined, function () { alert("COMING SOON!"); }));
				menuButton.addControl(new Button("images/help_about.svg", [18,18],				"Isometric Grid (Ctrl + X)",					undefined, function () { alert("COMING SOON!"); }));
				menuButton.addControl(new Button("images/help_about.svg", [18,18],				"No Grid (Ctrl + X)",							undefined, function () { alert("COMING SOON!"); }));
			...
			var menuButton = new MenuPopoutButton(undefined, undefined, "Modify", "bottom");
			{
				...
				menuButton.addControl(new Button("images/tool_move.svg",		[18,18], "Flip Horizontal",		"<hint>",	function(){ } ));
				menuButton.addControl(new Button("images/tool_move.svg",		[18,18], "Flip Vertical",		"<hint>",	function(){ } ));

				menuButton.addControl(new Divider());

				menuButton.addControl(new Button("images/tool_move.svg",		[18,18], "Align Left",					"<hint>",	function(){ } ));
				menuButton.addControl(new Button("images/tool_move.svg",		[18,18], "Align Right",					"<hint>",	function(){ } ));
				menuButton.addControl(new Button("images/tool_move.svg",		[18,18], "Align Top",					"<hint>",	function(){ } ));
				menuButton.addControl(new Button("images/tool_move.svg",		[18,18], "Align Bottom",				"<hint>",	function(){ } ));
				menuButton.addControl(new Button("images/tool_move.svg",		[18,18], "Align Centers Horizontal",	"<hint>",	function(){ } ));
				menuButton.addControl(new Button("images/tool_move.svg",		[18,18], "Align Centers Vertical",		"<hint>",	function(){ } ));

				menuButton.addControl(new Divider());

				menuButton.addControl(new Button("images/tool_move.svg",		[18,18], "Distribute Horizontally",					"<hint>",	function(){ } ));
				menuButton.addControl(new Button("images/tool_move.svg",		[18,18], "Distribute Vertically",					"<hint>",	function(){ } ));
