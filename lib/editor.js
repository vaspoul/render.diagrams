function GeneralDrawing(docTag)
{
	...
	function setup()
	{
		...
		// Object list
		{
			...
			(new Button("images/ungroup_selection.svg",	[18,18], undefined, "Ungroup (Ctrl+G)", ungroupSelection )).addControls(buttonAreaTop);
			(new Button("images/move_up.svg",			[18,18], undefined, "Move Up", moveUpSelection )).addControls(buttonAreaTop);
			(new Button("images/move_down.svg",			[18,18], undefined, "Move Down", moveDownSelection )).addControls(buttonAreaTop);

			(new Button("images/hide_selected.svg",		[18,18], undefined, "Hide Selected",	function() { alert("missing functionality"); }	)).addControls(buttonArea);
			(new Button("images/hide_unselected.svg",	[18,18], undefined, "Hide Unselected",	function() { alert("missing functionality"); }	)).addControls(buttonArea);
			(new Button("images/show_selected.svg",		[18,18], undefined, "Show Selected",	function() { alert("missing functionality"); }	)).addControls(buttonArea);
			(new Button("images/show_unselected.svg",	[18,18], undefined, "Show Unselected",	function() { alert("missing functionality"); }	)).addControls(buttonArea);
				
			(new Button("images/freeze_selected.svg",		[18,18], undefined, "Freeze Selected",		function() { alert("missing functionality"); }	)).addControls(buttonArea);
			(new Button("images/freeze_unselected.svg",		[18,18], undefined, "Freeze Unselected",	function() { alert("missing functionality"); }	)).addControls(buttonArea);
			(new Button("images/unfreeze_selected.svg",		[18,18], undefined, "Unfreeze Selected",	function() { alert("missing functionality"); }	)).addControls(buttonArea);
			(new Button("images/unfreeze_unselected.svg",	[18,18], undefined, "Unfreeze Unselected",	function() { alert("missing functionality"); }	)).addControls(buttonArea);
		...
		// File controls
		{
			...
			popoutMenuButton.addControl(new Button("images/new_drawing.svg", [24,24], "New Diagram", "Hint text",				function () { alert("missing functionality"); }));
			popoutMenuButton.addControl(new Button("images/save_drawing_localstorage.svg", [24,24], "Save to LocalStorage", "Hint text",	function () { saveToLocalStorage();			}));
			popoutMenuButton.addControl(new Button("images/load_drawing_localstorage.svg", [24,24], "Load from LocalStorage", "Hint text",	function () { openLocalStorage();			}));
			popoutMenuButton.addControl(new Button("images/export_drawing_image.svg", [24,24], "Save as Image", "Hint text",			function () { setTool("takeScreenshot");	}));
			popoutMenuButton.addControl(new Button("images/export_drawing_embed.svg", [24,24], "Export Embeddable", "Hint text",		function () { saveAsEmbeddableJavascript(); }));
			popoutMenuButton.addControl(new Button("images/export_drawing_js.svg", [24,24], "Export as JavaScript", "Hint text",	function () { saveAsJavascript();			}));
			popoutMenuButton.addControl(new Button("images/import_drawing_js.svg", [24,24], "Import from JavaScript", "Hint text",	function () { loadFromJavascript();			}));
			popoutMenuButton.addControl(new Button("images/open_example.svg", [24,24], "Open Example", "Hint text",			function () { alert("missing functionality");	}));
			...
			popoutMenuButton.addControl(new Divider());
			popoutMenuButton.addControl(new Button("images/help_about.svg", [24,24], "About", undefined,						function () { alert("missing functionality"); }));
		...
		// Tool palette
		{
			...
			(new Button("images/tool_move.svg",	[18,18], "Select/Move (Q)", "Hint text",		function(){setTool("select");} )).addControls(toolPalette);
			(new Button("images/tool_transform.svg",	[18,18], "Transform (T)", "Hint text",		function(){setTool("transform");} )).addControls(toolPalette);
			(new Button("images/tool_modify.svg",	[18,18], "Modify (V)", "Hint text",			function(){setTool("modify");} )).addControls(toolPalette);

			(new Divider()).addControls(toolPalette);

			(new Button("images/tool_wall.svg",	[18,18], "Wall (W)", "Hint text",			function () { setTool("addWall");} )).addControls(toolPalette);
			(new Button("images/tool_arc_wall.svg",		[18,18], "Arc Wall", "Hint text",			function () { setTool("addArcWall");} )).addControls(toolPalette);
			(new Button("images/tool_ray.svg",	[18,18], "BRDF Ray (B)", "Hint text",		function () { setTool("addRay"); } )).addControls(toolPalette);

			var popout = new MultiToolButton([18,18]);
			popout.addButton("images/tool_light_point.svg",	"Point Light", "Hint Point Light",			function() { setTool("addPointLight");		} );
			popout.addButton("images/tool_light_spot.svg",		"Spot Light", "Hint Spot Light",			function() { setTool("addSpotLight");		} );
			popout.addButton("images/tool_light_parallel.svg",	"Parallel Light", "Hint Parallel Light",	function() { setTool("addParallelLight");	} );
			popout.addControls(toolPalette);

			(new Button("images/tool_camera.svg",	[18,18],	"Camera (C)", "Hint text",				function () { setTool("addCamera"); }		)).addControls(toolPalette);
			(new Button("images/tool_hemisphere.svg",			[18,18],	"BRDF Hemisphere", "Hint text",			function () { setTool("addHemisphere"); }	)).addControls(toolPalette);
			(new Button("images/tool_line.svg",			[18,18],	"Line (L)", "Hint text",				function () { setTool("addLine"); }			)).addControls(toolPalette);
			(new Button("images/tool_rectangle.svg",		[18,18],	"Rectangle (R)", "Hint text",			function () { setTool("addRect"); }			)).addControls(toolPalette);
			(new Button("images/tool_ngon.svg",		[18,18],	"Circle / NGon (N)", "Hint text",		function () { setTool("addNGon"); }			)).addControls(toolPalette);
			(new Button("images/tool_bar_chart.svg",			[18,18],	"Bar Chart", "Hint text",				function () { setTool("addBarChart"); }		)).addControls(toolPalette);
			(new Button("images/tool_function_graph.svg",			[18,18],	"Function Graph", "Hint text",			function () { alert("missing functionality"); setTool("addFunctionGraph"); }		)).addControls(toolPalette);
			(new Button("images/tool_dimension.svg",			[18,18],	"Dimension (D)", "Hint text",			function () { setTool("addDimension"); }	)).addControls(toolPalette);
			(new Button("images/tool_text.svg",	[18,18],	"Text (X)", "Hint text",				function () { setTool("addText");}			)).addControls(toolPalette);
			(new Button("images/tool_axis.svg",			[18,18],	"Axis", "Hint text",					function () { setTool("addAxis"); }			)).addControls(toolPalette);
			(new Button("images/tool_page_outline.svg",			[18,18],	"Page Outline", "Hint text",			function () { alert("missing functionality"); setTool("addPageOutline"); }	)).addControls(toolPalette);

			var popout = new MultiToolButton([18,18]);
			popout.addButton("images/tool_tree.svg",	"Tree", "Hint text",			function() { addTree();		} );
			popout.addButton("images/tool_person.svg",		"Person", "Hint text",			function() { addPerson();	} );
			popout.addControls(toolPalette);
		...
		// Canvas controls
		{
			...
			popout.addButton("images/zoom_selection.svg",		undefined, "Zoom Selection (F)",	function() { alert("missing functionality"); }	 );
			...
			popoutMenuButton.addControl(new Tickbox("images/snaps_grid.svg", [18,18], "Grid", undefined, enableSnap["grid"], function (value) { enableSnap["grid"] = value; }) );
	...
	function loadPreferences()
	{
		...
		objectListDock.style.height = preferences.objectListDockHeight	|| 'auto';
