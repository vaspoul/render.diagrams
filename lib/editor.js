function GeneralDrawing(docTag)
{
	...
	function setup()
	{
		...
		// Object list
		{
			...
			(new Button("images/hide_selected.svg",		[18,18], undefined, "Hide Selected",	function() { modifyObjects(true, true, false);	}	)).addControls(buttonArea);
			(new Button("images/hide_unselected.svg",	[18,18], undefined, "Hide Unselected",	function() { modifyObjects(false, true, false); }	)).addControls(buttonArea);
			...
			(new Button("images/freeze_selected.svg",		[18,18], undefined, "Freeze Selected",		function() { modifyObjects(true, false, true); }	)).addControls(buttonArea);
			(new Button("images/freeze_unselected.svg",		[18,18], undefined, "Freeze Unselected",	function() { modifyObjects(false, false, true); }	)).addControls(buttonArea);
