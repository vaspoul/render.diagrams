function GeneralDrawing(docTag)
{
	...
	function setup()
	{
		...
		// Menu bar
		{
			...
			{
				menuButton.addControl( new Button("images/snaps_grid.svg",	[18,18], "New (Ctrl+G)", "<hint>", function() {} ) );
				menuButton.addControl( new Button("images/snaps_grid.svg",	[18,18], "Open (....)", "<hint>", function() {} ) );
				menuButton.addControl( new Button("images/snaps_grid.svg",	[18,18], "Save (....)", "<hint>", function() {} ) );
				menuButton.addControl( new Button("images/snaps_grid.svg",	[18,18], "Save As (....)", "<hint>", function() {} ) );
			}
	...
	function getCanvasProperties()
	{
		...
		[
			...
			{name: "Width", control: new PopoutSlider2(0, 5, 0.2, 1, function (value) {  }.bind(this)) },
		];
