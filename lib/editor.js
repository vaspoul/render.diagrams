	...
	function setup()
	{
		...
		// Menu bar
		{
			...
			var menuButton = new MenuPopoutButton(undefined, undefined, "Edit", "bottom");
			{
				...
				menuButton.addControl(new Button("images/help_about.svg", [18,18],				"Cut",				undefined, function () { clipboardCut(); }, "Ctrl+X" ));
				...
				menuButton.addControl(new Button("images/help_about.svg", [18,18],				"Unfreeze Selected",			undefined, function () { modifyObjects(true, false, false); }));
				menuButton.addControl(new Button("images/help_about.svg", [18,18],				"Unfreeze Unselected",			undefined, function () { modifyObjects(false, false, false); }));
				...
				menuButton.addControl(new Button("images/help_about.svg", [18,18],				"Unhide Selected",				undefined, function () { modifyObjects(true, true, true); }));
				menuButton.addControl(new Button("images/help_about.svg", [18,18],				"Unhide Unselected",			undefined, function () { modifyObjects(false, true, true); }));
			...
			{
				menuButton.addControl(new Button("images/help_about.svg", [18,18],				"Zoom Selected",					undefined, function () { zoomSelection(); }, ["F", "F2"]));
				menuButton.addControl(new Button("images/help_about.svg", [18,18],				"Zoom Extents",						undefined, function () { zoomExtents(); }, "F4"));
				...
				menuButton.addControl(new Tickbox("images/snaps_grid.svg",			[18,18], "Grid", undefined,					enableSnap["grid"],				function (value) { enableSnap["grid"] = value; } , "G"));
				...
				menuButton.addControl(new Tickbox("images/snaps_coincident.svg",	[18,18], "Coincident", undefined,			enableSnap["coincident"],		function (value) { enableSnap["coincident"] = value; }, "O" ));
				menuButton.addControl(new Tickbox("images/snaps_perpendicular.svg",	[18,18], "Perpendicular", undefined,		enableSnap["perpendicular"],	function (value) { enableSnap["perpendicular"] = value; }, "P" ));
				menuButton.addControl(new Tickbox("images/snaps_extend.svg",		[18,18], "Extend To", undefined,			enableSnap["extendTo"],			function (value) { enableSnap["extendTo"] = value; }, "E" ));
			}
			menuButton.addControls(menuBar);
