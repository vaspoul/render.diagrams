function GeneralDrawing(docTag)
{
	...
	function setTool(newTool)
	{
		...
		else if (newTool == "addPointLight"  || newTool == "addRect" || newTool == "addHemisphere" || newTool == "addNGon" || newTool == "addCapsule" || newTool == "addPoint" || newTool == "addLens" || newTool == "addDimension" || newTool == "takeScreenshot" || newTool == "addPageOutline" || newTool == "addFunctionGraph" || newTool == "addBouncingBall" || newTool == "addPen")
		{
			if (tool != newTool)
			{
				mode = null;
