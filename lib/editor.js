function GeneralDrawing(docTag)
{
	...
	function onMouseDown(evt)
	{
		...
		if (evt.buttons & 1)
		{
			...
			if (tool == "select")
			{
				...
				if (evt.altKey == 0)
				{
					snapPoint = scene.getSnapPoint(lastMousePos, [], camera.invScale(30), [objectBeingMade], enableSnap);
	...
	function onMouseMove(evt)
	{
		...
		if (evt.buttons == 0)
		{
			if (tool == "select")
			{
				var snapPoint = scene.getSnapPoint(lastMousePos, [], camera.invScale(30), [], enableSnap);
