function GeneralDrawing(docTag)
{
	...
	function setup()
	{
		...
		// Menu bar
		{
			...
			{
				menuButton.addControl( "", new Button("images/preferences.svg",	[18,18],				"Preferences",					undefined, function()  { showPreferencesDialog();				} ));
			...
			var menuButton = new MenuPopoutButton(undefined, undefined, "View", "bottom");
			{
				...
				menuButton.addControl("", new Tickbox("images/snaps_extend.svg",		[18,18], "Snap: Collision", undefined,			enableSnap["collision"],		function (value) { enableSnap["collision"] = value; } ));
			}
			menuButton.addControls(menuBar);
			...
			var menuButton = new MenuPopoutButton(undefined, undefined, "Create", "bottom");
			{
				...
				menuButton.addControl("", new Button("images/tool_ray.svg",			[18,18], "BRDF Ray", "Ray that bounces off rigid walls.", function () { setTool("addRay"); } ));
				...
				menuButton.addControl("", new Button("images/tool_pen.svg",				[18,18],	"Pen",					"Squiggly drawing pen.",																				function () { setTool("addPen"); }, "B" 				));
				menuButton.addControl("", new Button("images/tool_point.svg",			[18,18],	"Point",				"Point.",																								function () { setTool("addPoint"); }, "."				));
				menuButton.addControl("", new Button("images/tool_wall.svg",			[18,18],	"Diffraction Grating",	"Diffraction Grating plate.",																			function () { setTool("addDiffractionGrating"); }		));
				...
				menuButton.addControl("", new Button("images/tool_capsule.svg",			[18,18],	"Capsule",				"Capsule.",																								function () { setTool("addCapsule"); }, "U"				));
				menuButton.addControl("", new Button("images/tool_lens.svg",			[18,18],	"Lens",					"Lens.",																								function () { setTool("addLens"); }						));
				...
				menuButton.addControl("", new Button("images/tool_image.svg",			[18,18],	"Image",				"Adds an external image.",																				function () { setTool("addImage");}				));
			...
			var menuButton = new MenuPopoutButton(undefined, undefined, "Modify", "bottom");
			{
				...
				menuButton.addControl("", new Button("images/tool_extend.svg",					[18,18], "Extend",						"Extend lines.",							function(){setTool("extend");}, "E" ));
				menuButton.addControl("", new Button("images/tool_trim.svg",					[18,18], "Trim",						"Trim lines.",								function(){setTool("trim");}, "T" ));

				menuButton.addControl("", new Divider());

				menuButton.addControl("", new Button("images/flip_horizontal.svg",				[18,18], "Flip Horizontally",			"<hint>",	function(){ alert("COMING SOON!"); } ));
				menuButton.addControl("", new Button("images/flip_vertical.svg",				[18,18], "Flip Vertically",				"<hint>",	function(){ alert("COMING SOON!"); } ));
				...
				menuButton.addControl("", new Button("images/align_centers_horizontal.svg",		[18,18], "Align Centers Horizontally",	"<hint>",	function(){ alignObjects("centers-h"); } ));
				menuButton.addControl("", new Button("images/align_centers_vertical.svg",		[18,18], "Align Centers Vertically",	"<hint>",	function(){ alignObjects("centers-v"); } ));
		...
		// Property grid
		{
			propertyBarDock = document.getElementById("propertyGridList");
			propertyBar = new PropertyBar(propertyBarDock);
		}
		...
		// Tool palette
		{
			...
			(new Button("images/tool_extend.svg",	[18,18], "Extend",		"Extend lines.",							function(){setTool("extend");}, "E" )).addControls(toolPalette);
			(new Button("images/tool_trim.svg",		[18,18], "Trim",		"Trim lines.",								function(){setTool("trim");}, "T" )).addControls(toolPalette);
			...
			(new Button("images/tool_ray.svg",		[18,18], "BRDF Ray",	"Ray that bounces off rigid walls.", function () { setTool("addRay"); } )).addControls(toolPalette);
			...
			(new Button("images/tool_wall.svg",				[18,18],	"Diffraction Grating",	"Diffraction Grating plate.",																				function () { setTool("addDiffractionGrating"); }		)).addControls(toolPalette);
			(new Button("images/tool_point.svg",			[18,18],	"Point",				"Point.",																									function () { setTool("addPoint"); }, "."				)).addControls(toolPalette);
			...
			(new Button("images/tool_pen.svg",				[18,18],	"Pen",					"Squiggly marker pen.",																						function () { setTool("addPen"); }, "B"					)).addControls(toolPalette);
			...
			(new Button("images/tool_capsule.svg",			[18,18],	"Capsule",				"Capsule.",																									function () { setTool("addCapsule"); }, "U"				)).addControls(toolPalette);
			(new Button("images/tool_lens.svg",				[18,18],	"Lens",					"Lens.",																									function () { setTool("addLens"); }						)).addControls(toolPalette);
			...
			(new Button("images/tool_image.svg",			[18,18],	"Image",				"Adds an external image.",																					function () { setTool("addImage"); }					)).addControls(toolPalette);
		...
		// Canvas controls
		{
			...
			popoutMenuButton.addControl("", new Tickbox("images/snaps_extend.svg",			[18,18], "Collision", undefined,		enableSnap["collision"],		function (value) { enableSnap["collision"] = value; }) );
		...
		// Preferences Dialog
		{
			preferencesDialogDock = document.getElementById("preferencesDialogDock");
			preferencesDialogControls = document.getElementById("preferencesDialogControls");

			var preferencesDialog = new PropertyGrid(preferencesDialogControls);

			preferencesDialogDock.onshow = function()
			{
				preferencesDialog.displayPreferences = {...preferences};
				preferencesDialog.clearProperties();

				preferencesDialog.addProperty("Stay on tool after Lines", new TickBox(preferencesDialog.displayPreferences.stayOnTool_Line, function (value) { preferencesDialog.displayPreferences.stayOnTool_Line = value; }) );
				preferencesDialog.addProperty("Stay on tool after Pen", new TickBox(preferencesDialog.displayPreferences.stayOnTool_Pen, function (value) { preferencesDialog.displayPreferences.stayOnTool_Pen = value; }) );
				preferencesDialog.addProperty("Stay on tool after Point", new TickBox(preferencesDialog.displayPreferences.stayOnTool_Point, function (value) { preferencesDialog.displayPreferences.stayOnTool_Point = value; }) );
				preferencesDialog.addProperty("Animate Zoom", new TickBox(preferencesDialog.displayPreferences.animateZoom, function (value) { preferencesDialog.displayPreferences.animateZoom = value; }) );
			};

			var buttonPanel = preferencesDialogDock.querySelector("#buttonPanel");
			var okButton = buttonPanel.querySelector("#OKButton");
			var cancelButton = buttonPanel.querySelector("#CancelButton");

			okButton.onclick = function ()
									{
										preferences = {...preferencesDialog.displayPreferences};
										savePreferences();
										preferencesDialogDock.style.display = "none";
										canvas.focus();
										showingModal = false;
									}
		...
		window.onload = function()
		{
			...
			if (!preferences.seenTutorial_v1)
			{
				alert("A new tutorial page is available!\nYou can find it on the Help menu.");

				preferences.seenTutorial_v1 = true;
	...
	function setTool(newTool)
	{
		if (newTool == "cancel")
		{
			...
			if (tool == "addWall" || tool == "addLine")
			{
				if (objectBeingMade !== undefined && (objectBeingMade instanceof Wall || objectBeingMade instanceof Line))
				{
					...
					if (tool == "addLine" && preferences.stayOnTool_Line)
					{
						newTool = "addLine";
					}
				}
			}
			else if (tool == "addArcWall" || tool == "addRay" || tool == "addPointLight" || tool == "addSpotLight" || tool == "addParallelLight" || tool == "addCamera" || tool == "addRect" || tool == "addHemisphere" || tool == "addNGon" || tool == "addLens" || tool == "addPoint" || tool == "addCapsule" || tool == "addDimension" || tool == "addBarChart" || tool == "addFunctionGraph" || tool == "takeScreenshot" || tool == "addText" || tool == "addPen" || tool == "addAxis" || tool == "addPageOutline" || tool == "addImage" || tool == "addBouncingBall" || tool == "addDiffractionGrating")
			{
		...
		else if (newTool == "extend")
		{
			...
			tool = "extend";
			mouseCursor.shape = "cross";
			ShowGlobalHint("EXTEND", "Click to extend lines.");
		...
		else if (newTool == "trim")
		{
			...
			tool = "trim";
			mouseCursor.shape = "cross";
			ShowGlobalHint("TRIM", "Click to trim lines.");
		...
		else if (newTool == "addRay" || newTool == "addSpotLight" || newTool == "addParallelLight" || newTool == "addCamera" || newTool == "addBarChart" || newTool == "addText" || newTool == "addAxis" || newTool == "addDiffractionGrating")
		{
			if (tool != newTool)
			{
				mode = null;
		...
		else if (newTool == "addPointLight"  || newTool == "addRect" || newTool == "addHemisphere" || newTool == "addNGon" || newTool == "addCapsule" || newTool == "addPoint" || newTool == "addLens" || newTool == "addDimension" || newTool == "takeScreenshot" || newTool == "addPageOutline" || newTool == "addImage" || newTool == "addFunctionGraph" || newTool == "addBouncingBall" || newTool == "addPen")
		{
			if (tool != newTool)
			{
				mode = null;
			...
			else if (newTool == "addImage")
			{
				undoRedoSuspendBackup = true;
				objectBeingMade = new ImageObject(new Vector(1000, 1000));
				scene.addObject(objectBeingMade);
				undoRedoSuspendBackup = false;
			}
	...
	function onKeyDown(evt)
	{
		...
		if (evt.keyCode == 16) // Shift
		{
			...
			{
				shiftKeyHint.innerHTML = "Trim";
			}
			else if (tool == "trim")
			{
				shiftKeyHint.innerHTML = "Extend";
			}
		}
		...
		else if (evt.keyCode == 16 && tool == "extend") // shift
		{
			mouseCursor.shape = "cross";
			draw();
		}
		else if (evt.keyCode == 16 && tool == "trim") // shift
		{
			mouseCursor.shape = "cross";
			draw();
		}
	...
	function onMouseDown(evt)
	{
		...
		if (evt.buttons & 1)
		{
			...
			if (tool == "select")
			{
				...
				if (evt.altKey == 0)
				{
					snapPoint = scene.getSnapPoint(lastMousePos, camera.getSnapPoints(lastMousePos, undefined, undefined, enableSnap["grid"] ? grid : undefined), camera.invScale(30), enableSnap, [objectBeingMade]);
			...
			else if (tool == "transform")
			{
				...
				if (dragPoint.point !== null && dragPoint.object == transformRect)
				{
					...
					transformRect.startDrag(dragStartMousePos, dragPoint.index);
				}
				else
				{
					var s = scene.hitTest(sub(lastMousePos, threshold), add(lastMousePos, threshold), camera);
					...
					if (s.length == 0)
					{
						var snapPoint = scene.getSnapPoint(lastMousePos, [], camera.invScale(30), enableSnap, [objectBeingMade]);
	...
	function onMouseUp(evt)
	{
		...
		if (evt.button == 0) // object move or marquee
		{
			...
			else if (tool == "extend" || (tool == "trim" && evt.shiftKey))
			{
				var threshold = camera.invScale(10);
				
				var mouseRectMin = sub(lastMousePos, threshold);
				var mouseRectMax = add(lastMousePos, threshold);

				var objects = scene.hitTest(mouseRectMin, mouseRectMax, camera);

				var extendObject = undefined;

				for (var i=0; i!=objects.length; ++i)
				{
					var object = objects[objects.length-1-i];
				...
				if (extendObject !== undefined)
				{
					...
					extendObject.extend(mouseRectMin, mouseRectMax, camera, false);

					undoRedoSuspendBackup = false;
					onSceneChange();
				}
			}
			else if (tool == "trim" || (tool == "extend" && evt.shiftKey))
			{
				var threshold = camera.invScale(10);
				...
				var trimObject = undefined;

				for (var i=0; i!=objects.length; ++i)
				{
					var object = objects[objects.length-1-i];

					if (object.trim != undefined)
					{
						trimObject = object;
						break;
					}
				...
				if (trimObject !== undefined)
				{
					...
					trimObject.trim(mouseRectMin, mouseRectMax, camera, false);

					undoRedoSuspendBackup = false;
					onSceneChange();
				}
			}
			else if (tool == "addWall" || tool == "addArcWall" || tool == "addRay" || tool == "addPointLight" || tool == "addSpotLight" || tool == "addParallelLight" || tool == "addCamera" || tool == "addLine" || tool == "addRect" || tool == "addHemisphere" || tool == "addNGon" || tool == "addLens" || tool == "addCapsule" || tool == "addPoint" || tool == "addDimension" || tool == "addBarChart" || tool == "addFunctionGraph" || tool == "takeScreenshot" || tool == "addText" || tool == "addAxis" || tool == "addPageOutline" || tool == "addImage" || tool == "addBouncingBall" || tool == "addDiffractionGrating")
			{
				...
				if (evt.altKey == 0)
				{
					...
					snapPoint = scene.getSnapPoint(lastMousePos, camera.getSnapPoints(lastMousePos, previousMousePos, undefined, enableSnap["grid"] ? grid : undefined), camera.invScale(30), enableSnap, [objectBeingMade]);
				...
				else if (tool == "addDiffractionGrating")
				{
					if (objectBeingMade === undefined)
					{
						objectBeingMade = new DiffractionGrating(newPoint.copy());
						scene.addObject(objectBeingMade);
					}
					else
					{
				...
				else if (tool == "addImage")
				{
					if (objectBeingMade === undefined)
					{
						objectBeingMade = new ImageObject(newPoint.copy());
						scene.addObject(objectBeingMade);
					}
					else
					{
				...
				{
					objectBeingMade = new Point(newPoint.copy());
					scene.addObject(objectBeingMade);
				
					if (!preferences.stayOnTool_Point)
						setTool("select");
				...
				else if (tool == "addCapsule")
				{
					if (objectBeingMade === undefined)
					{
						objectBeingMade = new Capsule(newPoint.copy(), newPoint.copy(), 1);
						scene.addObject(objectBeingMade);
				...
				else if (tool == "addLens")
				{
					if (objectBeingMade === undefined)
					{
						objectBeingMade = new Lens(newPoint.copy(), newPoint.copy());
						scene.addObject(objectBeingMade);
						objectBeingMade.pointCount = 1;
					}
					else
				...
				else if (tool == "addDimension")
				{
					if (objectBeingMade === undefined)
					{
						...
						if (snapPoint != undefined && snapPoint.type == "coincident")
						{
							objectBeingMade.point1dir = transpose(snapPoint.N);
						}
						else
						{
							objectBeingMade.point1dir = undefined;
						}
					}
					else
					{
						if (objectBeingMade.pointCount == 1)
						{
							if (snapPoint != undefined && snapPoint.type == "coincident")
							{
								objectBeingMade.point2dir = transpose(snapPoint.N);
							}
							else
							{
								objectBeingMade.point2dir = undefined;
							}
						...
						{
							objectBeingMade.setDragPointPos(0, newPoint, evt.ctrlKey);
							setTool("select");
							setSelection([scene.objects[scene.objects.length-1]]);
						}
					}
			...
			else if (tool == "addPen")
			{
				if (objectBeingMade !== undefined)
				{
					var penObject = objectBeingMade;
				
					penObject.finalize(); // will do backup via onSceneChange

					objectBeingMade = undefined;

					if (!preferences.stayOnTool_Pen)
						setTool("select");

				//	if (penObject !== undefined)
				//	{
				//		setSelection([penObject]);
				//	}
				}
			}
	...
	{
		var newMousePos = getMousePosPixels(evt, canvas);
		...
		if (evt.buttons == 0)
		{
			if (tool == "select")
			{
				var snapPoint = scene.getSnapPoint(lastMousePos, camera.getSnapPoints(lastMousePos, undefined, undefined, enableSnap["grid"] ? grid : undefined), camera.invScale(30), enableSnap);
			...
			else if (tool == "extend" || (tool == "trim" && evt.shiftKey))
			{
				...
				if (extendObject !== undefined)
				{
					var extendPos = extendObject.extend(mouseRectMin, mouseRectMax, camera, true);

					if (extendPos != undefined)
					{
						camera.drawLine(extendPos.fromPos, extendPos.toPos, "#00e084", 2);
						
						if (extendPos.targetLineTo != undefined)
							camera.drawLine(extendPos.targetLineTo, extendPos.toPos, "#808080", 2, [5,5]);
					}
				}
			}
			else if (tool == "trim" || (tool == "extend" && evt.shiftKey))
			{
				...
				if (trimObject !== undefined)
				{
					var trimPos = trimObject.trim(mouseRectMin, mouseRectMax, camera, true);

					if (trimPos != undefined)
					{
						camera.drawLine(trimPos.fromPos, trimPos.toPos, "#FF0000", 4);
						
						if (trimPos.cutLine0From != undefined)
							camera.drawLine(trimPos.cutLine0From, trimPos.cutLine0To, "#808080", 4, [5,5]);

						if (trimPos.cutLine1From != undefined)
							camera.drawLine(trimPos.cutLine1From, trimPos.cutLine1To, "#808080", 4, [5,5]);
					}
				}
			}
			else if (tool == "addWall" || tool == "addArcWall" || tool == "addRay" || tool == "addPointLight" || tool == "addSpotLight" || tool == "addParallelLight" || tool == "addCamera" || tool == "addLine" || tool == "addRect" || tool == "addHemisphere" || tool == "addNGon" || tool == "addCapsule" || tool == "addPoint" || tool == "addLens" || tool == "addDimension" || tool == "addBarChart" || tool == "addFunctionGraph" || tool == "takeScreenshot" || tool == "addText" || tool == "addAxis" || tool == "addPageOutline" || tool == "addImage" || tool == "addBouncingBall" || tool == "addDiffractionGrating")
			{
				layerDirty[1] = true;
				...
				if (evt.ctrlKey && objectBeingMade !== undefined && tool != "addDimension")
				{
					newPoint = directionSnap(newPoint, lastMouseUpPos);
				}
				...
				else if (tool == "addPageOutline" || tool == "addImage" || tool == "addFunctionGraph" || tool == "addBouncingBall")
				{
					if (objectBeingMade !== undefined)
					{
						objectBeingMade.setOrigin(newPoint);
				...
				else if (tool == "addArcWall" || tool == "addRay" || tool == "addSpotLight" || tool == "addParallelLight" || tool == "addCamera" || tool == "addBarChart" || tool == "addText" || tool == "addPen" || tool == "addAxis" || tool == "addDiffractionGrating")
				{
					if (objectBeingMade !== undefined)
					{
		...
		else if (evt.buttons & 1) // object move or marquee
		{
			if (mode == "move")
			{
				...
				if (evt.altKey == 0 || tool == "transform")
				{
					...
					{
						if (dragPoint.object.allowSelfSnap)
							ignoreList = [];
						else
					...
					if (dragPoint != undefined && dragPoint.object != undefined && dragPoint.object.allowSelfSnap)
						snapPoint = scene.getSnapPoint(lastMousePos, camera.getSnapPoints(posForSnapSearch, previousMousePos, mouseDir, enableSnap["grid"] ? grid : undefined), camera.invScale(30), enableSnap, ignoreList, undefined, undefined, { object: dragPoint.object, index: dragPoint.index, localSpace: dragPoint.local });
					else
						snapPoint = scene.getSnapPoint(lastMousePos, camera.getSnapPoints(posForSnapSearch, previousMousePos, mouseDir, enableSnap["grid"] ? grid : undefined), camera.invScale(30), enableSnap, ignoreList);
			...
			else if (tool == "transform")
			{
				...
				else if (mode === "move")
				{
					...
					{
						layerDirty[1] = true;
						dragPoint.object.setDragPointPos(dragPoint.index, lastMousePos, evt.ctrlKey, evt.altKey, evt.ctrlKey, evt.shiftKey, camera);
					}
				}
			}
			else if (tool == "modify")
			{
				if (mode === "move")
				{
					...
					//camera.drawRectangle(lastMousePos, camera.invScale(10), "rgba(255,0,0,0.5)", 2);
			...
			else if (tool == "addPen")
			{
				if (objectBeingMade === undefined)
				{
					...
					objectBeingMade = new Pen();
					scene.addObject(objectBeingMade);

					undoRedoSuspendBackup = false;
				}

				objectBeingMade.addPoint( lastMousePos, camera );
		...
		//		snapPoint = scene.getSnapPoint(lastMousePos, camera.getSnapPoints(lastMousePos, previousMousePos, mouseDir, enableSnap["grid"] ? grid : undefined), camera.invScale(30), enableSnap, ignoreList);
	...
	function zoomExtents()
	{
		if (scene.objects.length>0)
		{
			...
			var propertyBarRect = propertyBarDock.getBoundingClientRect();

			var uniScaleX = rect.width / extents.x;
			var uniScaleY = (rect.height - propertyBarRect.bottom - 50) / extents.y;
	...
	function setSelection(s, ctrlKey, shiftKey)
	{
		...
		if (selectionList.length == 1) // show object's properties
		{
			propertyBar.setProperties(selectionList[0].getProperties());
		}
		else if (selectionList.length > 1) // show properties that exist in all of the selected objects
		{
			...
			var commonProperties = selectionList[0].getProperties().filter(function(element) { return element != undefined; } );
			...
			{
				var objectProperties = selectionList[i].getProperties().filter(function(element) { return element != undefined; } );
			...
			propertyBar.setProperties(commonProperties);
		}
		else // show document properties
		{
			propertyBar.setProperties(getCanvasProperties());
		}
	...
	function draw()
	{
		...
		if (g_zoomAnimation_stepsLeft>0)
		{
			...
			if (g_zoomAnimation_stepsLeft>0)
			{
				g_zoomAnimation_timer = setTimeout(	function() { draw() }, 20 );
			}
		}
	...
	function drawSnapPoint(snapPoint)
	{
		...
		{
			if (snapPoint.gridSnap == true)
			{
				camera.drawArc(snapPoint.p, camera.invScale(5), 0, 2*Math.PI, "#0084e0", 2);
				camera.drawCross(snapPoint.p, camera.invScale(8), 45 * Math.PI/180, "#0084e0", 2);
			}
			else
			{
				camera.drawArc(snapPoint.p, camera.invScale(5), 0, 2*Math.PI, "#0084e0", 2);
		...
		else if (snapPoint.type == "collision")
		{
			camera.drawRectangle(snapPoint.p, camera.invScale(10), "#0084e0", 2);
		}
		else
	...
	function saveAsEmbeddableJavascript()
	{
		...
		popupHeader += "<script type=\"text/javascript\" src=\"lib/sceneObject_arcWall.js\"></script>\n";
		popupHeader += "<script type=\"text/javascript\" src=\"lib/sceneObject_axis.js\"></script>\n";
		popupHeader += "<script type=\"text/javascript\" src=\"lib/sceneObject_barChart.js\"></script>\n";
		popupHeader += "<script type=\"text/javascript\" src=\"lib/sceneObject_bouncingBall.js\"></script>\n";
		popupHeader += "<script type=\"text/javascript\" src=\"lib/sceneObject_brdfHemisphere.js\"></script>\n";
		popupHeader += "<script type=\"text/javascript\" src=\"lib/sceneObject_brdfRay.js\"></script>\n";
		popupHeader += "<script type=\"text/javascript\" src=\"lib/sceneObject_camera.js\"></script>\n";
		popupHeader += "<script type=\"text/javascript\" src=\"lib/sceneObject_dimension.js\"></script>\n";
		popupHeader += "<script type=\"text/javascript\" src=\"lib/sceneObject_editorInternals.js\"></script>\n";
		popupHeader += "<script type=\"text/javascript\" src=\"lib/sceneObject_functionGraph.js\"></script>\n";
		popupHeader += "<script type=\"text/javascript\" src=\"lib/sceneObject_line.js\"></script>\n";
		popupHeader += "<script type=\"text/javascript\" src=\"lib/sceneObject_ngon.js\"></script>\n";
		popupHeader += "<script type=\"text/javascript\" src=\"lib/sceneObject_point.js\"></script>\n";
		popupHeader += "<script type=\"text/javascript\" src=\"lib/sceneObject_capsule.js\"></script>\n";
		popupHeader += "<script type=\"text/javascript\" src=\"lib/sceneObject_lens.js\"></script>\n";
		popupHeader += "<script type=\"text/javascript\" src=\"lib/sceneObject_pageOutline.js\"></script>\n";
		popupHeader += "<script type=\"text/javascript\" src=\"lib/sceneObject_parallelLight.js\"></script>\n";
		popupHeader += "<script type=\"text/javascript\" src=\"lib/sceneObject_pointLight.js\"></script>\n";
		popupHeader += "<script type=\"text/javascript\" src=\"lib/sceneObject_rectangle.js\"></script>\n";
		popupHeader += "<script type=\"text/javascript\" src=\"lib/sceneObject_spotLight.js\"></script>\n";
		popupHeader += "<script type=\"text/javascript\" src=\"lib/sceneObject_text.js\"></script>\n";
		popupHeader += "<script type=\"text/javascript\" src=\"lib/sceneObject_wall.js\"></script>\n";
	...
	{
		preferences.animateZoom			= true;
		preferences.stayOnTool_Line		= false;
		preferences.stayOnTool_Pen		= true;
		preferences.stayOnTool_Point	= true;
		preferences.seenTutorial_v1		= false;
	...
	function showPreferencesDialog()
	{
		...
		preferencesDialogDock.onshow();
		preferencesDialogDock.style.display = "flex";
		preferencesDialogDock.focus();
	}
	...
	function loadFromLocalStorage(sceneKey)
	{
		...
		if (sceneCode != undefined)
		{
			...
			scene.suspendOnChangeOnAddObject = true;
			loadFromJavascript(sceneCode);
			scene.suspendOnChangeOnAddObject = false;
			scene.onChange();

			var t1 = performance.now();
			console.log("loadFromLocalStorage " + (t1-t0).toFixed(2) + " ms");
	...
	function loadTutorial()
	{
		...
		var t1 = performance.now();
		console.log("loadTutorialScene " + (t1-t0).toFixed(2) + " ms");
	}
	...
	function addPerson()
	{
		...
		var aw = new ArcWall(new Vector(-1, 11), 1, 0, Math.PI * 2);
		aw.convex = true;
		aw.roughness = 0;
		aw.metalness = 0;
	...
	function onSceneChange(caller, changeDetails)
	{
		...
		if (changeDetails.dontBackup == undefined || changeDetails.dontBackup == false)
		{
			backup();
		}
	}
	...
	function updateObjectList()
	{
		...
		for (var i=0; i!=scene.objects.length; ++i)
		{
			...
			if (scene.objects[i].name != undefined)
			{
				str = scene.objects[i].name;// + " [" + scene.objects[i].constructor.name + "]";
			}

			if (scene.objects[i].isSelected())
				nameCell.style.fontWeight = 'bold';

			nameCell.textContent = str;
	...
	function directionSnap(currentPos, startPos)
	{
		...
		snappedPoint = mad(dir, dot(delta, dir), startPos);
