	...
	function setup()
	{
		...
		// Menu bar
		{
			...
			var menuButton = new MenuPopoutButton(undefined, undefined, "Edit", "bottom");
			{
				...
				menuButton.addControl(new Button("images/invert_selection.svg", [18,18],			"Invert Selection",				undefined, function () { alert("COMING SOON!"); }, "Ctrl+Shift+I" ));
			...
			var menuButton = new MenuPopoutButton(undefined, undefined, "Modify", "bottom");
			{
				...
				menuButton.addControl(new Button("images/align_left.svg",					[18,18], "Align Left",					"<hint>",	function(){ alert("COMING SOON!"); } ));
				menuButton.addControl(new Button("images/align_right.svg",					[18,18], "Align Right",					"<hint>",	function(){ alert("COMING SOON!"); } ));
				menuButton.addControl(new Button("images/align_top.svg",					[18,18], "Align Top",					"<hint>",	function(){ alert("COMING SOON!"); } ));
				menuButton.addControl(new Button("images/align_bottom.svg",					[18,18], "Align Bottom",				"<hint>",	function(){ alert("COMING SOON!"); } ));
				menuButton.addControl(new Button("images/align_centers_horizontal.svg",		[18,18], "Align Centers Horizontal",	"<hint>",	function(){ alert("COMING SOON!"); } ));
				menuButton.addControl(new Button("images/align_centers_vertical.svg",		[18,18], "Align Centers Vertical",		"<hint>",	function(){ alert("COMING SOON!"); } ));

				menuButton.addControl(new Divider());

				menuButton.addControl(new Button("images/distribute_horizontal.svg",		[18,18], "Distribute Horizontally",					"<hint>",	function(){ alert("COMING SOON!"); } ));
				menuButton.addControl(new Button("images/distribute_vertical.svg",			[18,18], "Distribute Vertically",					"<hint>",	function(){ alert("COMING SOON!"); } ));
