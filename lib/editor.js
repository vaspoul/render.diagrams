	...
	function setup()
	{
		...
		// Menu bar
		{
			...
			var menuButton = new MenuPopoutButton(undefined, undefined, "Edit", "bottom");
			{
				...
				menuButton.addControl(new Button("images/move_up.svg", [18,18],						"Bring Forward",				undefined, function () { moveUpSelection(); }, "Ctrl+Alt+PageUp" ));
				menuButton.addControl(new Button("images/move_down.svg", [18,18],					"Send Back",					undefined, function () { moveDownSelection(); }, "Ctrl+Alt+PageDown" ));
