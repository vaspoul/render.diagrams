	...
	function setup()
	{
		...
		// Menu bar
		{
			...
			var menuButton = new MenuPopoutButton(undefined, undefined, "Create", "bottom");
			{
				...
				menuButton.addControl("", new Button("images/tool_wall.svg",			[18,18],	"Diffraction Grating",	"Diffraction Grating plate.",																			function () { setTool("addDiffractionGrating"); }, "G"	));
		...
		// Tool palette
		{
			...
			(new Button("images/tool_wall.svg",				[18,18],	"Diffraction Grating",	"Diffraction Grating plate.",																			function () { setTool("addDiffractionGrating"); }, "G"	)).addControls(toolPalette);
			...
			if (mode == "move")
			{
				...
				if (evt.altKey == 0 || tool == "transform")
				{
					...
					if (tool == "select")
						...
						ignoreList = [];//[dragPoint.object]; // allow snapping onto itself?
