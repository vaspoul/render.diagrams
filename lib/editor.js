	...
	function setup()
	{
		...
		// Menu bar
		{
			...
			var menuButton = new MenuPopoutButton(undefined, undefined, "Create", "bottom");
			{
				...
				menuButton.addControl("", new Button("images/tool_pen.svg",				[18,18],	"Pen",					"Squiggly drawing pen.",																				function () { setTool("addPen"); } 						));
		...
		// Tool palette
		{
			...
			(new Button("images/tool_pen.svg",				[18,18],	"Pen",					"Squiggly marker pen.",																						function () { setTool("addPen"); }						)).addControls(toolPalette);
