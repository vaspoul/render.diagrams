function GeneralDrawing(docTag)
{
	...
	function setup()
	{
		...
		// Tool palette
		{
			...
			(new Button("images/tool_page_outline.svg",		[18,18],	"Page Outline",			"Adds a standard page outline.",																		function () { alert("missing functionality"); setTool("addPageOutline"); }	)).addControls(toolPalette);
