function GeneralDrawing(docTag)
{
	...
	function setup()
	{
		...
		// Menu bar
		{
			...
			{
				menuButton.addControl(new Button("images/help_about.svg", [18,18],				"Undo",				undefined, function () { undo(); }, "Ctrl+Z"));
				menuButton.addControl(new Button("images/help_about.svg", [18,18],				"Redo",				undefined, function () { redo(); }, ["Ctrl+Shift+Z", "Ctrl+Y"] ));

				menuButton.addControl(new Divider());
	
				menuButton.addControl(new Button("images/help_about.svg", [18,18],				"Cut",				undefined, function () { alert("COMING SOON!"); }));
				menuButton.addControl(new Button("images/help_about.svg", [18,18],				"Copy",				undefined, function () { clipboardCopy(); }, "Ctrl+C" ));
				menuButton.addControl(new Button("images/help_about.svg", [18,18],				"Paste",			undefined, function () { clipboardPaste(); }, "Ctrl+V"));

				menuButton.addControl(new Divider());

				menuButton.addControl(new Button("images/help_about.svg", [18,18],				"Select All",					undefined, function () { selectAll(); }, "Ctrl+A" ));
				menuButton.addControl(new Button("images/help_about.svg", [18,18],				"Invert Selection",				undefined, function () { alert("COMING SOON!"); }, "Ctrl+Shift+I" ));

				menuButton.addControl(new Divider());

				menuButton.addControl(new Button("images/help_about.svg", [18,18],				"Freeze Selected",				undefined, function () { modifyObjects(true, false, true); }, "Ctrl+F" ));
				menuButton.addControl(new Button("images/help_about.svg", [18,18],				"Freeze Unselected",			undefined, function () { modifyObjects(false, false, true); }, "Ctrl+Shift+F"));
				menuButton.addControl(new Button("images/help_about.svg", [18,18],				"Unfreeze Selected",			undefined, function () { alert("COMING SOON!"); }));
				menuButton.addControl(new Button("images/help_about.svg", [18,18],				"Unfreeze Unselected",			undefined, function () { alert("COMING SOON!"); }));
				menuButton.addControl(new Button("images/help_about.svg", [18,18],				"Unfreeze All",					undefined, function () { modifyObjects(false, false, false); modifyObjects(true, false, false); }, "Ctrl+Alt+F"));

				menuButton.addControl(new Divider());

				menuButton.addControl(new Button("images/help_about.svg", [18,18],				"Hide Selected",				undefined, function () { modifyObjects(true, true, false); }, "Ctrl+H" ));
				menuButton.addControl(new Button("images/help_about.svg", [18,18],				"Hide Unselected",				undefined, function () { modifyObjects(false, true, false); }, "Ctrl+Shift+H"));
				menuButton.addControl(new Button("images/help_about.svg", [18,18],				"Unhide Selected",				undefined, function () { alert("COMING SOON!"); }));
				menuButton.addControl(new Button("images/help_about.svg", [18,18],				"Unhide Unselected",			undefined, function () { alert("COMING SOON!"); }));
				menuButton.addControl(new Button("images/help_about.svg", [18,18],				"Unhide All",					undefined, function () { modifyObjects(false, true, true); modifyObjects(true, true, true); }, "Ctrl+Alt+H" ));

				menuButton.addControl(new Divider());

				menuButton.addControl(new Button("images/help_about.svg", [18,18],				"Group",						undefined, function () { groupSelection(); }, "Ctrl+G" ));
				menuButton.addControl(new Button("images/help_about.svg", [18,18],				"Ungroup",						undefined, function () { ungroupSelection(); }, "Ctrl+Shift+G" ));

				menuButton.addControl(new Button("images/help_about.svg", [18,18],				"Bring Forward",				undefined, function () { moveUpSelection(); }, "Ctrl+Alt+PageUp" ));
				menuButton.addControl(new Button("images/help_about.svg", [18,18],				"Send Back",					undefined, function () { moveDownSelection(); }, "Ctrl+Alt+PageDown" ));
			...
			{
				menuButton.addControl(new Button("images/help_about.svg", [18,18],				"Zoom Selected",					undefined, function () { alert("COMING SOON!"); }));
				menuButton.addControl(new Button("images/help_about.svg", [18,18],				"Zoom Extents",						undefined, function () { alert("COMING SOON!"); }));

				menuButton.addControl(new Divider());

				menuButton.addControl(new Button("images/help_about.svg", [18,18],				"Cartesian Grid",					undefined, function () { alert("COMING SOON!"); }));
				menuButton.addControl(new Button("images/help_about.svg", [18,18],				"Radial Grid",						undefined, function () { alert("COMING SOON!"); }));
				menuButton.addControl(new Button("images/help_about.svg", [18,18],				"Isometric Grid",					undefined, function () { alert("COMING SOON!"); }));
				menuButton.addControl(new Button("images/help_about.svg", [18,18],				"No Grid",							undefined, function () { alert("COMING SOON!"); }));

				menuButton.addControl(new Divider());

				menuButton.addControl(new Tickbox("images/snaps_grid.svg",			[18,18], "Grid (G)", undefined,				enableSnap["grid"],				function (value) { enableSnap["grid"] = value; }) );
				menuButton.addControl(new Tickbox("images/snaps_node.svg",			[18,18], "Node", undefined,					enableSnap["node"],				function (value) { enableSnap["node"] = value; }) );
				menuButton.addControl(new Tickbox("images/snaps_intersection.svg",	[18,18], "Intersection", undefined,			enableSnap["intersection"],		function (value) { enableSnap["intersection"] = value; }) );
				menuButton.addControl(new Tickbox("images/snaps_midpoint.svg",		[18,18], "Midpoint", undefined,				enableSnap["midpoint"],			function (value) { enableSnap["midpoint"] = value; }) );
				menuButton.addControl(new Tickbox("images/snaps_coincident.svg",	[18,18], "Coincident (O)", undefined,		enableSnap["coincident"],		function (value) { enableSnap["coincident"] = value; }) );
				menuButton.addControl(new Tickbox("images/snaps_perpendicular.svg",	[18,18], "Perpendicular (P)", undefined,	enableSnap["perpendicular"],	function (value) { enableSnap["perpendicular"] = value; }) );
				menuButton.addControl(new Tickbox("images/snaps_extend.svg",		[18,18], "Extend To (E)", undefined,		enableSnap["extendTo"],			function (value) { enableSnap["extendTo"] = value; }) );
			}
			menuButton.addControls(menuBar);

			var menuButton = new MenuPopoutButton(undefined, undefined, "Create", "bottom");
			{
				menuButton.addControl(new Button("images/tool_wall.svg",		[18,18], "Wall (W)", "Rigid straight wall, multiple segments. Use this to contruct walls, rooms, objects, etc. Can bounce rays.", function () { setTool("addWall");} ));
				menuButton.addControl(new Button("images/tool_arc_wall.svg",	[18,18], "Arc Wall", "Circular rigid wall. ", function () { setTool("addArcWall");} ));
				menuButton.addControl(new Button("images/tool_ray.svg",			[18,18], "BRDF Ray (B)", "Ray that bounces off rigid walls.", function () { setTool("addRay"); } ));
				...
				menuButton.addControl(new Button("images/tool_camera.svg",			[18,18],	"Camera (C)",			"Camera fustrum outline.<p>Can 'collide' with rigid walls.<p>Has pixel & Z Buffer functionality.",		function () { setTool("addCamera"); }		));
				...
				menuButton.addControl(new Button("images/tool_line.svg",			[18,18],	"Line (L)",				"Multi-line, non-collidable.<p>Can draw arrows.<p>Has 'pixelation' mode.",								function () { setTool("addLine"); }			));
				menuButton.addControl(new Button("images/tool_rectangle.svg",		[18,18],	"Rectangle (R)",		"Axis aligned rectangle.<p>Can be sub-divided into rows & columns to form a grid.",						function () { setTool("addRect"); }			));
				menuButton.addControl(new Button("images/tool_ngon.svg",			[18,18],	"Circle / NGon (N)",	"Circle or regular polygon.",																			function () { setTool("addNGon"); }			));
				...
				menuButton.addControl(new Button("images/tool_function_graph.svg",	[18,18],	"Function Graph",		"Plot a graph of a user-supplied function.<p>COMING SOON!",												function () { alert("missing functionality"); setTool("addFunctionGraph"); }		));
				menuButton.addControl(new Button("images/tool_dimension.svg",		[18,18],	"Dimension (D)",		"Adds a dimension.",																					function () { setTool("addDimension"); }	));
				menuButton.addControl(new Button("images/tool_text.svg",			[18,18],	"Text (X)",				"Adds text object.",																					function () { setTool("addText");}			));
			...
			{
				menuButton.addControl(new Button("images/tool_move.svg",		[18,18], "Select/Move (Q)", "Move objects, without modifying them.",	function(){setTool("select");} ));
				menuButton.addControl(new Button("images/tool_transform.svg",	[18,18], "Transform (T)",	"Scale/Rotate objects.",					function(){setTool("transform");} ));
				menuButton.addControl(new Button("images/tool_modify.svg",		[18,18], "Modify (V)",		"Modify object nodes.",						function(){setTool("modify");} ));

				menuButton.addControl(new Divider());

				menuButton.addControl(new Button("images/tool_move.svg",		[18,18], "Flip Horizontal",		"<hint>",	function(){ alert("COMING SOON!"); } ));
				menuButton.addControl(new Button("images/tool_move.svg",		[18,18], "Flip Vertical",		"<hint>",	function(){ alert("COMING SOON!"); } ));

				menuButton.addControl(new Divider());

				menuButton.addControl(new Button("images/tool_move.svg",		[18,18], "Align Left",					"<hint>",	function(){ alert("COMING SOON!"); } ));
				menuButton.addControl(new Button("images/tool_move.svg",		[18,18], "Align Right",					"<hint>",	function(){ alert("COMING SOON!"); } ));
				menuButton.addControl(new Button("images/tool_move.svg",		[18,18], "Align Top",					"<hint>",	function(){ alert("COMING SOON!"); } ));
				menuButton.addControl(new Button("images/tool_move.svg",		[18,18], "Align Bottom",				"<hint>",	function(){ alert("COMING SOON!"); } ));
				menuButton.addControl(new Button("images/tool_move.svg",		[18,18], "Align Centers Horizontal",	"<hint>",	function(){ alert("COMING SOON!"); } ));
				menuButton.addControl(new Button("images/tool_move.svg",		[18,18], "Align Centers Vertical",		"<hint>",	function(){ alert("COMING SOON!"); } ));

				menuButton.addControl(new Divider());

				menuButton.addControl(new Button("images/tool_move.svg",		[18,18], "Distribute Horizontally",					"<hint>",	function(){ alert("COMING SOON!"); } ));
				menuButton.addControl(new Button("images/tool_move.svg",		[18,18], "Distribute Vertically",					"<hint>",	function(){ alert("COMING SOON!"); } ));
