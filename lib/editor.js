function GeneralDrawing(docTag)
{
	...
	function setup()
	{
		...
		// Button list
		{
			...
			buttonList.addProperty(undefined, new Button("Add BRDF Hemisphere", function () { setTool("addHemisphere"); }));
			...
			buttonList.addProperty(undefined, new Button("Load from LocalStorage", function () { openLocalStorage(); }));
			buttonList.addProperty(undefined, new Divider());
	...
	function saveToLocalStorage(autoSave)
	{
		...
		localStorage.setItem("savedScene:" + sceneName, scene.name);
				...
				imageCell.ondblclick = function()
					{
						...
						loadFromLocalStorage(sceneName);
	...
	function loadFromLocalStorage(sceneName)
	{
		if (typeof (Storage) === "undefined")
			return false;
