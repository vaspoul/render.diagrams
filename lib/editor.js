function GeneralDrawing(docTag)
{
	...
	function setup()
	{
		...
		// File controls
		{
			...
			popoutMenuButton.addControl(new Button("images/new_drawing.svg", [24,24],				"New Diagram",				undefined, function () { newDrawing(); }));
			popoutMenuButton.addControl(new Button("images/save_drawing_localstorage.svg", [24,24], "Save to LocalStorage",		undefined, function () { saveToLocalStorage();			}));
			popoutMenuButton.addControl(new Button("images/load_drawing_localstorage.svg", [24,24], "Load from LocalStorage",	undefined, function () { openLocalStorage();			}));
			...
			popoutMenuButton.addControl(new Button("images/import_drawing_js.svg", [24,24],			"Import from JavaScript",	undefined, function () { loadFromJavascript();			}));
			popoutMenuButton.addControl(new Button("images/open_example.svg", [24,24],				"Open Example",				undefined, function () { alert("missing functionality");	}));
	...
	function onMouseMove(evt)
	{
		...
		if (evt.buttons == 0)
		{
			...
			else if (tool == "addWall" || tool == "addArcWall" || tool == "addRay" || tool == "addSpotLight" || tool == "addParallelLight" || tool == "addCamera" || tool == "addLine" || tool == "addRect" || tool == "addHemisphere" || tool == "addNGon" || tool == "addDimension" || tool == "addBarChart" || tool == "takeScreenshot" || tool == "addText" || tool == "addAxis" || tool == "addPageOutline")
			{
				layerDirty[1] = true;
