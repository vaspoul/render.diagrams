function GeneralDrawing(docTag)
{
	...
	function setup()
	{
		...
		// Property grid
		{
			...
			propertyGridDock.style.display = "none";
		...
		// Object list
		{
			...
			objectListDock.style.display = "none";
		...
		// Button list
		{
			...
			buttonListdDock.style.display = "none";
			root.appendChild(buttonListdDock);

			buttonList = new PropertyGrid(buttonListdDock);

			buttonList.addProperty(undefined, new Button(undefined, undefined, "Select/Move (Q)", function(){setTool("select");}));
			buttonList.addProperty(undefined, new Button(undefined, undefined, "Transform (T)", function(){setTool("transform");}));
			buttonList.addProperty(undefined, new Button(undefined, undefined, "Modify (V)", function(){setTool("modify");}));
			buttonList.addProperty(undefined, new Button(undefined, undefined, "Zoom Extents (F4)", function(){zoomExtents();}));
			buttonList.addProperty(undefined, new Divider());
			buttonList.addProperty(undefined, new Button(undefined, undefined, "Add Wall (W)", function(){setTool("addWall");}));
			buttonList.addProperty(undefined, new Button(undefined, undefined, "Add Arc Wall", function(){setTool("addArcWall");}));
			buttonList.addProperty(undefined, new Button(undefined, undefined, "Add BRDF Ray (B)", function () { setTool("addRay"); }));
			buttonList.addProperty(undefined, new Button(undefined, undefined, "Add Point Light", function () { setTool("addPointLight"); }));
			buttonList.addProperty(undefined, new Button(undefined, undefined, "Add Spot Light", function () { setTool("addSpotLight"); }));
			buttonList.addProperty(undefined, new Button(undefined, undefined, "Add Parallel Light", function () { setTool("addParallelLight"); }));
			buttonList.addProperty(undefined, new Button(undefined, undefined, "Add Camera (C)", function () { setTool("addCamera"); }));
			buttonList.addProperty(undefined, new Button(undefined, undefined, "Add BRDF Hemisphere", function () { setTool("addHemisphere"); }));
			buttonList.addProperty(undefined, new Button(undefined, undefined, "Add Line (L)", function () { setTool("addLine"); }));
			buttonList.addProperty(undefined, new Button(undefined, undefined, "Add Rectangle (R)", function () { setTool("addRect"); }));
			buttonList.addProperty(undefined, new Button(undefined, undefined, "Add Circle / NGon (N)", function () { setTool("addNGon"); }));
			buttonList.addProperty(undefined, new Button(undefined, undefined, "Add Bar Chart", function () { setTool("addBarChart"); }));
			buttonList.addProperty(undefined, new Button(undefined, undefined, "Add Dimension (D)", function () { setTool("addDimension"); }));
			buttonList.addProperty(undefined, new Button(undefined, undefined, "Add Text (X)", function(){setTool("addText");}));
			buttonList.addProperty(undefined, new Button(undefined, undefined, "Add Axis", function () { setTool("addAxis"); }));
			buttonList.addProperty(undefined, new Button(undefined, undefined, "Add Tree", function () { addTree(); }));
			buttonList.addProperty(undefined, new Button(undefined, undefined, "Add Person", function () { addPerson(); }));
			buttonList.addProperty(undefined, new Divider());
			buttonList.addProperty(undefined, new Button(undefined, undefined, "Save to LocalStorage", function () { saveToLocalStorage(); }));
			buttonList.addProperty(undefined, new Button(undefined, undefined, "Load from LocalStorage", function () { openLocalStorage(); }));
			buttonList.addProperty(undefined, new Divider());
			buttonList.addProperty(undefined, new Button(undefined, undefined, "Save as Image", function () { setTool("takeScreenshot"); }));
			buttonList.addProperty(undefined, new Button(undefined, undefined, "Export as JavaScript", function () { saveAsJavascript(); }));
			buttonList.addProperty(undefined, new Button(undefined, undefined, "Export Embeddable", function () { saveAsEmbeddableJavascript(); }));
			buttonList.addProperty(undefined, new Button(undefined, undefined, "Import from JavaScript", function () { loadFromJavascript(); }));
		}
		...
		// File controls
		{
			...
			fileControlDock.style.background = "#EEEEEE";
			...
			popoutMenuButton.addControl(new Button("images/cloud-computing-2.svg", [24,24], "New Diagram",				function () { alert("missing functionality"); }));
			popoutMenuButton.addControl(new Button("images/cloud-computing-2.svg", [24,24], "Save to LocalStorage",		function () { saveToLocalStorage();			}));
			popoutMenuButton.addControl(new Button("images/cloud-computing-3.svg", [24,24], "Load from LocalStorage",	function () { openLocalStorage();			}));
			popoutMenuButton.addControl(new Button("images/cloud-computing-4.svg", [24,24], "Save as Image",			function () { setTool("takeScreenshot");	}));
			popoutMenuButton.addControl(new Button("images/cloud-computing-2.svg", [24,24], "Export Embeddable",		function () { saveAsEmbeddableJavascript(); }));
			popoutMenuButton.addControl(new Button("images/cloud-computing-3.svg", [24,24], "Export as JavaScript",		function () { saveAsJavascript();			}));
			popoutMenuButton.addControl(new Button("images/cloud-computing-4.svg", [24,24], "Import from JavaScript",	function () { loadFromJavascript();			}));
			popoutMenuButton.addControl(new Button("images/cloud-computing-4.svg", [24,24], "About",					function () { alert("missing functionality"); }));
		...
		// Scene controls
		{
			var sceneControlDock = document.createElement('div');
			sceneControlDock.id = "sceneControls";
			sceneControlDock.style.position = "fixed";
			sceneControlDock.style.left = 5;
			//sceneControlDock.style.display = "block";
			sceneControlDock.style.top = 5;
			sceneControlDock.style.border = "1px solid #BBBBBB";
			sceneControlDock.style.boxShadow = "3px 3px 5px #999999";

			(new Tickbox("images/preferences.svg",	[18,18],	"Show Grid",	showGrid,	function () { }								)).addControls(sceneControlDock);

			(new Button("images/cloud-computing-2.svg",	[18,18], "Select/Move (Q)",		function(){setTool("select");} )).addControls(sceneControlDock);
			(new Button("images/cloud-computing-3.svg",	[18,18], "Transform (T)",		function(){setTool("transform");} )).addControls(sceneControlDock);
			(new Button("images/cloud-computing-4.svg",	[18,18], "Modify (V)",			function(){setTool("modify");} )).addControls(sceneControlDock);

			(new Divider()).addControls(sceneControlDock);

			(new Button("images/barcode-qr.svg",	[18,18], "Add Wall (W)",			function () { setTool("addWall");} )).addControls(sceneControlDock);
			(new Button("images/award-48.svg",		[18,18], "Add Arc Wall",			function () { setTool("addArcWall");} )).addControls(sceneControlDock);
			(new Button("images/briefcase-24.svg",	[18,18], "Add BRDF Ray (B)",		function () { setTool("addRay"); } )).addControls(sceneControlDock);

			var popout = new MultiToolButton([18,18]);
			popout.addButton("images/loading-3.svg",	"Add Point Light",		function() { setTool("addPointLight");		} );
			popout.addButton("images/skull-2.svg",		"Add Spot Light",		function() { setTool("addSpotLight");		} );
			popout.addButton("images/spaceship.svg",	"Add Parallel Light",	function() { setTool("addParallelLight");	} );
			popout.addControls(sceneControlDock);

			(new Button("images/settings-gear-63.svg",	[18,18],	"Add Camera (C)",			function () { setTool("addCamera"); }		)).addControls(sceneControlDock);
			(new Button("images/single-01.svg",			[18,18],	"Add BRDF Hemisphere",		function () { setTool("addHemisphere"); }	)).addControls(sceneControlDock);
			(new Button("images/phone-2.svg",			[18,18],	"Add Line (L)",				function () { setTool("addLine"); }			)).addControls(sceneControlDock);
			(new Button("images/preferences.svg",		[18,18],	"Add Rectangle (R)",		function () { setTool("addRect"); }			)).addControls(sceneControlDock);
			(new Button("images/support-16.svg",		[18,18],	"Add Circle / NGon (N)",	function () { setTool("addNGon"); }			)).addControls(sceneControlDock);
			(new Button("images/switch.svg",			[18,18],	"Add Bar Chart",			function () { setTool("addBarChart"); }		)).addControls(sceneControlDock);
			(new Button("images/flash-21.svg",			[18,18],	"Add Dimension (D)",		function () { setTool("addDimension"); }	)).addControls(sceneControlDock);
			(new Button("images/flag-points-32.svg",	[18,18],	"Add Text (X)",				function () { setTool("addText");}			)).addControls(sceneControlDock);
			(new Button("images/eye-19.svg",			[18,18],	"Add Axis",					function () { setTool("addAxis"); }			)).addControls(sceneControlDock);

			//var popout = new PopoutButton("right", undefined, [18,18]);
			//popout.addButton("images/multiple-11.svg",	function() { addTree();		}, "Add Person" );
			//popout.addButton("images/handout.svg",		function() { addPerson();	}, "Add Tree" );
			//popout.addControls(sceneControlDock);
			
			root.appendChild(sceneControlDock);
		}

		// Canvas controls
		{
			var canvasControlDock = document.createElement('div');
			canvasControlDock.id = "canvasControls";
			canvasControlDock.style.textAlign = "center";
			canvasControlDock.style.bottom = 8;
			canvasControlDock.style.position = "fixed";
			canvasControlDock.style.left = 0;
			canvasControlDock.style.right = 0;
			canvasControlDock.style.marginLeft = "auto";
			canvasControlDock.style.marginRight = "auto";
			canvasControlDock.style.width = "100px";
			canvasControlDock.style.padding = "0 5px";
			canvasControlDock.style.background = "#EEEEEE";
			canvasControlDock.style.border = "1px solid black";
			canvasControlDock.style.boxShadow = "3px 3px 5px #999999";

			//var popout = new MultiToolButton([18,18]);
			//popout.addButton("images/menu-5.svg",		function() { showGrid = true; grid.type = 0; layerDirty[0] = true; draw(); },	"Grid: Cartesian" );
			//popout.addButton("images/vector.svg",		function() { showGrid = true; grid.type = 1; layerDirty[0] = true; draw(); },	"Grid: Isometric" );
			//popout.addButton("images/lock-open.svg",	function() { showGrid = true; grid.type = 2; layerDirty[0] = true; draw(); },	"Grid: Radial" );
			//popout.addButton("images/world.svg",		function() { showGrid = false; layerDirty[0] = true; draw(); },					"Grid: None" );

			//popout.addControls(canvasControlDock);
			
			root.appendChild(canvasControlDock);
		}
