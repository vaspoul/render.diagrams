function GeneralDrawing(docTag)
{
	...
	function setTool(newTool)
	{
		if (newTool == "cancel")
		{
			...
			else if (tool == "addArcWall" || tool == "addRay" || tool == "addPointLight" || tool == "addSpotLight" || tool == "addParallelLight" || tool == "addCamera" || tool == "addRect" || tool == "addHemisphere" || tool == "addNGon" || tool == "addDimension" || tool == "addBarChart" || tool == "addFunctionGraph" || tool == "takeScreenshot" || tool == "addText" || tool == "addAxis" || tool == "addPageOutline")
			{
		...
		else if (newTool == "addPointLight"  || newTool == "addRect" || newTool == "addHemisphere" || newTool == "addNGon" || newTool == "addDimension" || newTool == "takeScreenshot" || newTool == "addPageOutline" || newTool == "addFunctionGraph")
		{
			if (tool != newTool)
			{
				mode = null;
	...
	function onMouseMove(evt)
	{
		...
		if (evt.buttons == 0)
		{
			...
			else if (tool == "addWall" || tool == "addArcWall" || tool == "addRay" || tool == "addPointLight" || tool == "addSpotLight" || tool == "addParallelLight" || tool == "addCamera" || tool == "addLine" || tool == "addRect" || tool == "addHemisphere" || tool == "addNGon" || tool == "addDimension" || tool == "addBarChart" || tool == "addFunctionGraph" || tool == "takeScreenshot" || tool == "addText" || tool == "addAxis" || tool == "addPageOutline")
			{
				...
				else if (tool == "addArcWall" || tool == "addPageOutline" || tool == "addFunctionGraph")
				{
					if (objectBeingMade !== undefined)
					{
						objectBeingMade.setOrigin(newPoint);
	...
	function zoom(center, scale)
	{
		if (preferences.animateZoom)
		{
			...
			g_zoomAnimation_scaleDelta = (scale - camera.getUnitScale()) / g_zoomAnimation_stepsLeft;
			...
			g_zoomAnimation_timer = setInterval(	function()
													{
														...
														camera.setUnitScale(camera.getUnitScale() + g_zoomAnimation_scaleDelta);
														grid.spacing = Math.pow(10, Math.ceil(Math.log10(camera.invScale(10))));
	...
	function toggleObjectListCollapse(force)
	{
		...
		if (collapse)
		{
			...
			objectList.style.visibility = "hidden";
			buttonArea.style.visibility = "hidden";
			buttonAreaTop.style.visibility = "hidden";
		...
		else
		{
			...
			buttonAreaTop.style.visibility = "visible";
