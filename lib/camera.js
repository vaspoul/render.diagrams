function Camera(canvas)
{
	...
	function drawLineStrip(points,color,width,dash,ownerObject)
	{
		if (ownerObject !== undefined)
		{
		...
		return graphics.drawLineStrip(points, color, width, dash);
	}

	function drawLines(points, color, width, dash, ownerObject)
	{
		if (ownerObject !== undefined)
		{
			for (var i = 0; i != points.length - 1; ++i)
	...
	function getSnapPoints(mousePoint)
	{
		var points = [];
