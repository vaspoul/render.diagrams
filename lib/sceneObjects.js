...
function FunctionGraph(origin)
{
	...
	this.getProperties = function()
	{
		return	[
					...
					{name: "X Step", control: new PopoutSlider(0, 5, this.xStep, 0.1, function (value) { this.xStep = value; this.onChange(); }.bind(this)) },
					{name: "", control: new PlainButton("Auto Fit", function() { this.autoFit(); this.onChange(); }.bind(this)) },
				];
	}
