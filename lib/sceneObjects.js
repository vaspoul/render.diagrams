...
function FunctionGraph(origin)
{
	...
	this.functionStr			= 
		...
		"// Your function will be passed a variable 'x' for which the\n" +
		"// function will be evaluated.\n" +
		"// For cartesian graphs, x will be the value of the X axis.\n" +
		"// For polar graphcs, x will be the angle in radians.\n" +
		"\n"+
