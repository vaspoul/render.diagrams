...
function Rectangle(center)
{
	...
	this.hitTest = function(a, b)
	{
		return	intersectRectLine(a, b, this.points[0], this.points[1]) ||
...
function Grid()
{
	...
	this.draw = function(camera)
	{
		...
		else if (this.type == "radial")
		{
			...
			{
				camera.drawLine(this.O, mad(fromAngle(a*Math.PI/180), maxRadius, this.O), this.color, this.width);
			}
