...
function FunctionGraph(origin)
{
	...
	this.getProperties = function()
	{
		...
		return	[
					...
					(this.coordinateType == 0) ? undefined : {name: "Visibility Raycasts", control: new TickBox(this.doRayCasting, function (value) { this.doRayCasting = value; this.onChange(); }.bind(this)) },
				];
	}
