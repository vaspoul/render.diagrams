...
function Wall(_points)
{
	...
	this.getProperties = function()
	{
		return	[
					...
					{ name: "Normals", control: new PlainButton("Flip", function() { this.points.reverse(); this.onChange(); }.bind(this)) },
					...
					{ name: "Intensity", control: new Slider(0, 10, this.intensity, 0.1, function (value) { this.intensity = value; this.onChange(); }.bind(this)) },
...
function ArcWall(centerPos, radius, startAngle, endAngle)
{
	...
	this.getProperties = function()
	{
		return	[
					{ name: "Color", control:new ColorPicker(this.color, function(value){ this.color = value; this.onChange(); }.bind(this) )},
					{ name: "Normals", control: new PlainButton("Flip", function () { this.convex = !this.convex; this.onChange(); }.bind(this)) },
					{ name: "Roughness", control: new Slider(0, 1, this.roughness, 0.1, function (value) { this.roughness = value; this.onChange(); }.bind(this)) },
					{ name: "Metalness", control: new Slider(0, 1, this.metalness, 0.1, function (value) { this.metalness = value; this.onChange(); }.bind(this)) },
					{ name: "Intensity", control: new Slider(0, 10, this.intensity, 0.1, function (value) { this.intensity = value; this.onChange(); }.bind(this)) },
					{ name: "BRDF", control: new Dropdown(["Lambert", "Phong"], this.BRDFIndex, function (value) { this.BRDFIndex = value; this.onChange(); }.bind(this)) },
...
function CameraObject(O, target, fovDegrees)
{
	...
	this.drawDragPoint = function(camera, index, localSpace)
	{
		...
		if (localSpace)
		{
			if (index == 0)
			{
				camera.drawLine(this.O, mad(this.dir, 1, this.O), "#ff0000", 4);
			}
			else if (index==1)
			{
				camera.drawLine(this.target, mad(this.dir, -1, this.target), "#ff0000", 4);
			}
		}
		else
		{
	...
	this.getProperties = function()
	{
		return	[
					...
					{ name: "Collision Outline", control: new TickBox(this.collisionOutline, function (value) { this.collisionOutline = value; this.onChange(); }.bind(this)) },
					{ name: "Span Count", control: new Slider(0, 10, this.spanCount, 1, function (value) { this.spanCount = value; this.onChange(); }.bind(this)) },
...
function BarChart(A, B)
{
	...
	this.getProperties = function()
	{
		return	[
					...
					{name: "Values Function", control: new TextBox(this.valuesFunctionStr, false, false, 0, function (value) { this.valuesFunctionStr = value; this.onChange(); }.bind(this)) }
				];
	}
...
function Text(anchorPoint, initialText)
{
	...
	this.getProperties = function()
	{
		return	[
					...
					{name: "Font Size", control: new Slider(0.1, 5.0, this.fontSize, 0.1, function (value) { this.fontSize = value; this.onChange(); }.bind(this)) },
					{name: "Line Spacing", control: new Slider(0.1, 5.0, this.lineSpacing, 0.1, function (value) { this.lineSpacing = value; this.onChange(); }.bind(this)) },
...
function PageOutline(origin)
{
	...
	this.drawDragPoint = function(camera, index, localSpace)
	{
		camera.drawRectangle(this.origin, camera.invScale(10), "#ff0000", 2);
	}
	...
	this.getProperties = function()
	{
		return	[
					...
					{ name: "Margin", control: new Slider(0, 5, this.margin, 0.25, function (value) { this.margin = value; this.onChange(); }.bind(this)) },
				];
	}
...
function Axis(firstPoint)
{
	...
	{
		return	[
					{name: "Spacing", control: new Slider(0.5, 10, this.spacing, 0.5, function (value) { this.spacing = Math.max(0.1,value); this.onChange(); }.bind(this)) },
					{name: "Text Label", control: new Slider(-1, 1, this.textLabel, 1, function (value) { this.textLabel = value; this.onChange(); }.bind(this)) },
				];
	}
...
function ScreenshotArea(p, okCallback, cancelCallback)
{
	...
	{
		okCallback(this.formatIndex, true);
	}

	this.onSaveClicked = function()
	{
		okCallback(this.formatIndex, false);
	}
}
