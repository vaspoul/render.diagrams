...
function BRDFHemisphere(centerPos, radius, normal)
{
	...
	this.BRDF				= Phong;
	this.BRDFIndex			= 1;
	this.BRDFOptions		= [ CosineLobe, Phong, ConstantHemi ];
	this.metalness			= 0;
	this.roughness			= 0;
	this.intensity			= 1;
	this.showBRDF			= true;
	...
	this.getProperties = function()
	{
		return	[
					...
					{name: "BRDF", control: new Dropdown(["CosineLobe", "Phong", "Constant"], this.BRDFIndex, function (value) { this.BRDFIndex = value; this.onChange(); }.bind(this)) },
				];
	}
