...
function CameraObject(O, target, fovDegrees)
{
	...
	this.draw = function(camera)
	{
		...
		if (this.collisionOutline || this.showMinZBuffer)
		{
			...
			var farStepCount = Math.round(this.farWidth / 0.125);
			var farStep = this.farWidth / farStepCount;
			var nearStep = this.nearWidth / farStepCount;
...
function BarChart(A, B)
{
	...
	this.getProperties = function()
	{
		return	[
					...
					{name: "Values Function", control: new TextBox(this.valuesFunctionStr, false, 0, function (value) { this.valuesFunctionStr = value; this.onChange(); }.bind(this)) }
				];
	}
...
function Text(anchorPoint, initialText)
{
	...
	this.getProperties = function()
	{
		return	[
					{name: "Color", control:new ColorPicker(this.color, function(value){ this.color = value; this.onChange(); }.bind(this) )},
					{name: "Text", control:new TextBox(this.text, false, 0, function(value){ this.setText(value); this.onChange(); }.bind(this) )},
					{name: "Font", control:new TextBox(this.font, true, 32, function(value){ this.font = value; this.onChange(); }.bind(this) )},
...
function ScreenshotArea(p, okCallback, cancelCallback)
{
	...
	this.getProperties = function()
	{
		return	[
					...
					{ name: undefined, control: new PlainButton("OK", okCallback) },
