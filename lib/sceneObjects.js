...
function Wall(_points)
{
	...
	this.draw = function(camera)
	{
		...
		for (var i = 0; i != this.points.length - 1; ++i)
		{
			...
			if (this.roughness == 0)
			{
				camera.drawLine(this.points[i], this.points[i + 1], this.color, width, [], this);
			}
			else
			{
				var l0 = div(L, 60);
...
function Line(A, B)
{
	...
	this.onChange = function()
	{
		...
		this.boundsMin = min(this.boundsMin, this.B);
		this.boundsMax = max(this.boundsMax, this.B);
...
function Rectangle(center)
{
	...
	this.saveAsJavascript = function()
	{
		...
		str += "rectObj.lineColor = \"" + this.lineColor + "\";\n";
	...
	this.draw = function(camera)
	{
		...
		camera.drawLineStrip([this.points[0], this.points[1], this.points[2], this.points[3], this.points[0]], this.lineColor, width, [], this);
		...
		camera.drawRectangle(this.points[0], this.points[2], "rgba(0,0,0,0)", width, [], fillColorRGBA);
	}
	...
	this.getSnapPoints = function()
	{
		return [	{ type: "node", p: this.points[0] },
	...
	this.properties =
	[
		{name: "Outline Color", control:new ColorPicker(this.lineColor, function(value){ this.lineColor = value; this.onChange(); }.bind(this) )},
		{name: "Fill Color", control:new ColorPicker(this.fillColor, function(value){ this.fillColor = value; this.onChange(); }.bind(this) )},
		{name: "Fill Alpha", control: new Slider(0, 1, this.fillAlpha, 0.1, function (value) { this.fillAlpha = value; this.onChange(); }.bind(this)) },
  	];
...
function Hemisphere(centerPos, radius, normal)
{
	...
	this.draw = function(camera)
	{
		...
		camera.drawArrow(this.center, this.normal, this.radius * 0.5, "#000000", width);
