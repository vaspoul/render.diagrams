...
function Text(anchorPoint, initialText)
{
	...
	this.getProperties = function()
	{
		return	[
					{name: "Color", control:new ColorPicker(this.color, function(value){ this.color = value; this.onChange(); }.bind(this) )},
					{name: "Text", control:new TextBox(this.text, false, function(value){ this.setText(value); this.onChange(); }.bind(this) )},
					{name: "Font", control:new TextBox(this.font, true, function(value){ this.font = value; this.onChange(); }.bind(this) )},
