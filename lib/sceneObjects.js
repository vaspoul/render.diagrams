...
var lastBarChartFillColor = "#000000";
var lastBarChartAlpha = 0;
...
function BarChart(A, B)
{
	...
	this.onChange = function()
	{
		...
		// Update values
		{
			...
			for (var i = 0; i != this.values.length; ++i)
			{
				this.values[i] = valuesFunction(i);
			}
		}
	...
	this.setDragPointPos = function(index, p, localSpace)
	{
		...
		else
		{
			...
			this.values[index - 2] = dot(sub(p, this.A), tan);
		}
	...
	this.getProperties = function()
	{
		return	[
					...
					{name: "ValuesFunction", control: new TextBox(this.valuesFunctionStr, function (value) { this.valuesFunctionStr = value; this.onChange(); }.bind(this)) }
				];
	}
