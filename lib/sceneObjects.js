...
function Wall(_points)
{
	...
	this.drawDragPoint = function(camera, index, localSpace, alpha)
	{
		if (alpha == undefined)
			alpha = 1;
		...
		if (localSpace)
		{
			...
			camera.drawLine(this.points[index0], add(this.points[index0], L), "rgba(255,0,0," + alpha + ")", 4);
		}
		else
		{
...
function ArcWall(centerPos, radius, startAngle, endAngle)
{
	...
	this.drawDragPoint = function(camera, index, localSpace, alpha)
	{
		...
		if (localSpace)
		{
			...
			{
				camera.drawLine(add(this.center, mul(fromAngle(this.startAngle), this.radius)), add(this.center, mul(fromAngle(this.startAngle), this.radius*0.9)), "rgba(255,0,0," + alpha + ")", 4);
			}
			else if (index == 2)
			{
			...
			{
				camera.drawLine(add(this.center, mul(fromAngle(this.endAngle), this.radius)), add(this.center, mul(fromAngle(this.endAngle), this.radius*0.9)), "rgba(255,0,0," + alpha + ")", 4);
			}
		}
		else
		{
	...
	this.drawDragPoint = function(camera, index, localSpace, alpha)
	{
		...
		else
		{
			if (localSpace)
			{
				...
				camera.drawLine(add(add(this.O, this.dir), delta), sub(add(this.O, this.dir), delta), "rgba(255,0,0," + alpha + ")", 4);
			}
			else
			{
...
function SpotLight(O, target, fovDegrees)
{
	...
	this.drawDragPoint = function(camera, index, localSpace, alpha)
	{
		...
		if (localSpace)
		{
			if (index == 0)
			{
				camera.drawLine(this.O, mad(dir, 1, this.O), "rgba(255,0,0," + alpha + ")", 4);
			}
			else if (index==1)
			{
				camera.drawLine(this.target, mad(dir, -1, this.target), "rgba(255,0,0," + alpha + ")", 4);
			}
		}
		else
		{
			...
			{
				camera.drawRectangle(add(this.O, mul(tan, this.nearWidth / 2)), camera.invScale(10), "rgba(255,0,0," + alpha + ")", 2);
			}
			else if (index==3)
			{
				camera.drawRectangle(add(this.O, mul(tan, -this.nearWidth/2)), camera.invScale(10), "rgba(255,0,0," + alpha + ")", 2);
			...
			{
				camera.drawRectangle(add(this.target, mul(tan, this.farWidth / 2)), camera.invScale(10), "rgba(255,0,0," + alpha + ")", 2);
			}
			else if (index==5)
			{
				camera.drawRectangle(add(this.target, mul(tan, -this.farWidth/2)), camera.invScale(10), "rgba(255,0,0," + alpha + ")", 2);
...
function ParallelLight(O, dir)
{
	...
	this.drawDragPoint = function(camera, index, localSpace, alpha)
	{
		...
		{
			camera.drawRectangle(add(this.O, mul(tan, this.width/2)), camera.invScale(10), "rgba(255,0,0," + alpha + ")", 2);
		}
		else if (index==3)
		{
			camera.drawRectangle(add(this.O, mul(tan, -this.width/2)), camera.invScale(10), "rgba(255,0,0," + alpha + ")", 2);
...
function CameraObject(O, target, fovDegrees)
{
	...
	this.drawDragPoint = function(camera, index, localSpace, alpha)
	{
		...
		if (localSpace)
		{
			if (index == 0)
			{
				camera.drawLine(this.O, mad(this.dir, 1, this.O), "rgba(255,0,0," + alpha + ")", 4);
			}
			else if (index==1)
			{
				camera.drawLine(this.target, mad(this.dir, -1, this.target), "rgba(255,0,0," + alpha + ")", 4);
			}
		}
		else
		{
...
function Axis(firstPoint)
{
	...
	this.draw = function(camera)
	{
		...
		if (this.orientation == "horizontal")
		{
			...
			tan = mul(transpose(dir), camera.invScale(this.textLabel>=0 ? 10 : -10));
			textAlign = "center";
			textOffset = this.textLabel>=0 ? 2.5 : 1.5;
		}
		else
		{
			v0 = this.p0.y;
			...
			tan = mul(transpose(dir), camera.invScale(this.textLabel>=0 ? -10 : 10));
			textAlign = this.textLabel>=0 ? "right" : "left";
			textOffset = this.textLabel>=0 ? 2.5 : 2.5;
		}
	...
	this.getProperties = function()
	{
		return	[
					...
					{name: "Text Label", control: new PopoutSlider(-1, 1, this.textLabel, 1, function (value) { this.textLabel = value; this.onChange(); }.bind(this)) },
				];
	}
