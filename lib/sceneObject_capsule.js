...
function Capsule(p0, p1, radius)
{
	...
	this.draw = function(camera)
	{
		...
		if (this.sideCount>=30)
		{
			...
			camera.drawLine(mad(tan, this.radius, this.p0), mad(tan, this.radius, this.p1), this.appearance.GetLineColor(), this.appearance.GetLineWidth(this.selected), this.appearance.GetLineDash(), this);
			camera.drawLine(mad(tan, -this.radius, this.p0), mad(tan, -this.radius, this.p1), this.appearance.GetLineColor(), this.appearance.GetLineWidth(this.selected), this.appearance.GetLineDash(), this);
