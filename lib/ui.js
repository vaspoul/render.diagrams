...
function Button(imgSrc, sizeOverride, textLabel, hintText, callback)
{
	...
	this.addControls = function(parentElement)
	{
		...
		this.btn.className = "toolbar";
		this.btn.style.padding = "2px 10px 2px 10px";
		this.btn.style.display = "inherit";
		
		this.btn.onmouseenter = function() 
		{
			this.btn.style.background = "#AAAAAA";
			...
			if (hintText)
			{
				...
				{
					this.hintDiv = new ShowHint([rect.left, rect.top, rect.right, rect.bottom], textLabel, hintText, parentElement);
				}.bind(this), 300 );
			}
...
function TextBox(value, singleLine, maxLength, callback)
{
	...
	this.addControls = function(parentElement)
	{
		if (singleLine)
		{
			...
			textArea.style.background = "#F5F5E5";
			textArea.type = "text";
...
function ShowHint(anchorPoint, title, contents, parentElement)
{
	this.hintDiv = undefined;
	...
	this.makeDiv = function()
	{
		...
		this.hintDiv.style.border = "1px solid black";
		this.hintDiv.style.boxShadow = "3px 3px 5px #999999";

		this.hintDiv.style.left = anchorPoint[0];
		this.hintDiv.style.top = anchorPoint[1];
		this.hintDiv.style.maxWidth = 250;
		this.hintDiv.style.padding = "0px 10px";
		this.hintDiv.style.borderRadius = "8px";
		this.hintDiv.style.color = "white";
		this.hintDiv.style.pointerEvents = "none";

		if (title)
			this.hintDiv.innerHTML = "<h1 class=\"HintTitle\">" + title + "</h1>";
		else
