...
function Pen()
{
	...
	this.draw = function(camera)
	{
		...
		{
			camera.drawLineStrip(this.pointsAvg, false, this.appearance.GetLineColor(), this.appearance.GetLineWidth(this.selected), this.appearance.GetLineDash());
			//camera.drawLineStrip(this.pointsAvg, false, "#0000FF", this.appearance.GetLineWidth(this.selected), this.appearance.GetLineDash());
		}
		...
		for (var i = 0; i != this.bezierCurves.length; ++i)
		{
			if (this.drawBezier)
			{
				camera.drawBezierCurve( this.bezierCurves[i][0], this.bezierCurves[i][1], this.bezierCurves[i][2], this.bezierCurves[i][3], this.appearance.GetLineColor(), this.appearance.GetLineWidth(this.selected), this.appearance.GetLineDash(), this);
				//camera.drawBezierCurve( this.bezierCurves[i][0], this.bezierCurves[i][1], this.bezierCurves[i][2], this.bezierCurves[i][3], "#FF0000", this.appearance.GetLineWidth(this.selected), this.appearance.GetLineDash(), this);
			}
	...
	this.getSnapPoints = function()
	{
		...
		for (var i = 0; i != this.pointsAvg.length; ++i)
		{
			points.push({ type: "node", p: this.pointsAvg[i]});
		}
